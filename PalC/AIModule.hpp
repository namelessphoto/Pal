...
{
    TEnumAsByte<EBTDecoratorLogic> Operation;
    uint16 Number;
...
struct FEnvOverlapData
{
    ...
    TEnumAsByte<EEnvOverlapShape> OverlapShape;
...
struct FEnvTraceData
{
    ...
    TEnumAsByte<EEnvTraceShape> TraceShape;
    TEnumAsByte<EEnvQueryTrace> TraceMode;
    uint8 bTraceComplex;
    uint8 bOnlyBlockingHits;
...
class AAIController : public AController
{
    ...
    void AIMoveCompletedSignature(FAIRequestID RequestID, TEnumAsByte<EPathFollowingResult> Result);
    ...
    TEnumAsByte<EPathFollowingRequestResult> MoveToLocation(const FVector& Dest, float AcceptanceRadius, bool bStopOnOverlap, bool bUsePathfinding, bool bProjectDestinationToNavigation, bool bCanStrafe, TSubclassOf<class UNavigationQueryFilter> FilterClass, bool bAllowPartialPath);
    TEnumAsByte<EPathFollowingRequestResult> MoveToActor(class AActor* Goal, float AcceptanceRadius, bool bStopOnOverlap, bool bUsePathfinding, bool bCanStrafe, TSubclassOf<class UNavigationQueryFilter> FilterClass, bool bAllowPartialPath);
...
class UAIAsyncTaskBlueprintProxy : public UObject
{
    ...
    void OAISimpleDelegate(TEnumAsByte<EPathFollowingResult> MovementResult);
    FAIAsyncTaskBlueprintProxyOnFail OnFail;
    void OAISimpleDelegate(TEnumAsByte<EPathFollowingResult> MovementResult);

    void OnMoveCompleted(FAIRequestID RequestID, TEnumAsByte<EPathFollowingResult> MovementResult);
};
...
class UAITask_MoveTo : public UAITask
{
    ...
    void MoveTaskCompletedSignature(TEnumAsByte<EPathFollowingResult> Result, class AAIController* AIController);
...
{
    TEnumAsByte<EBTNodeResult> Result;
...
{
    TSubclassOf<class AActor> AllowedActorClass;
    FAIDataProviderFloatValue SearchRadius;
    TSubclassOf<class UEnvQueryContext> ListenerContext;
...
class UEnvQueryInstanceBlueprintWrapper : public UObject
{
    ...
    void EQSQueryDoneSignature(class UEnvQueryInstanceBlueprintWrapper* QueryInstance, TEnumAsByte<EEnvQueryStatus> QueryStatus);
...
class UEnvQueryManager : public UAISubsystem
{
    ...
    class UEnvQueryInstanceBlueprintWrapper* RunEQSQuery(class UObject* WorldContextObject, class UEnvQuery* QueryTemplate, class UObject* Querier, TEnumAsByte<EEnvQueryRunMode> RunMode, TSubclassOf<class UEnvQueryInstanceBlueprintWrapper> WrapperClass);
};
...
class UPawnAction_Move : public UPawnAction
{
    ...
    uint8 bAbortSubActionOnPathChange;

...
public:
    ...
    UFUNCTION(BlueprintCallable)
    static bool GetTrackingOriginTransform(TEnumAsByte<EHMDTrackingOrigin> Origin, FTransform& OutTransform);
    ...
    UFUNCTION(BlueprintCallable)
    static FVector2D GetPlayAreaBounds(TEnumAsByte<EHMDTrackingOrigin> Origin);
    ...
    UFUNCTION(BlueprintCallable)
    static TEnumAsByte<EXRDeviceConnectionResult> ConnectRemoteXRDevice(const FString& ipAddress, const int32 BitRate);

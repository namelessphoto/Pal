...
void UPalAIActionComponent::SetRootComposite(UPalAIActionCompositeBase* NewCompositeAction, TEnumAsByte<EAIRequestPriority> Priority) {
}
...
void UPalAIActionComponent::SetAction(UPawnAction* NewAction, TEnumAsByte<EAIRequestPriority> Priority, UObject* Instigator) {
}
...
bool UPalAIActionComponent::HasAction(const TSubclassOf<UPawnAction>& checkClass, TEnumAsByte<EAIRequestPriority> checkPriority) const {
    return false;
}
...
UPalAIActionCompositeBase* UPalAIActionComponent::GetCompositeRoot(TEnumAsByte<EAIRequestPriority> Priority) const {
    return NULL;
}

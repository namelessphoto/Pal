...
void APartyBeaconClient::ClientReservationResponse_Implementation(TEnumAsByte<EPartyReservationResult> ReservationResponse) {
}

void APartyBeaconClient::ClientCancelReservationResponse_Implementation(TEnumAsByte<EPartyReservationResult> ReservationResponse) {
}

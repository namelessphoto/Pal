...
void ASpectatorBeaconClient::ClientReservationResponse_Implementation(TEnumAsByte<ESpectatorReservationResult> ReservationResponse) {
}

void ASpectatorBeaconClient::ClientCancelReservationResponse_Implementation(TEnumAsByte<ESpectatorReservationResult> ReservationResponse) {
}

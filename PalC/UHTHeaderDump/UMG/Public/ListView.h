...
public:
    ...
    void SetSelectionMode(TEnumAsByte<ESelectionMode> NewSelectionMode);
...
protected:
    UFUNCTION()
    void OnListItemOuterEndPlayed(AActor* ItemOuter, TEnumAsByte<EEndPlayReason> EndPlayReason);
    
    UFUNCTION()
    void OnListItemEndPlayed(AActor* Item, TEnumAsByte<EEndPlayReason> EndPlayReason);

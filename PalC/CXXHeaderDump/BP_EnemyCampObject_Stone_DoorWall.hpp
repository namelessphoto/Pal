...
class ABP_EnemyCampObject_Stone_DoorWall_C : public APalBuildObjectBasicBase
{
    ...
    float _______RotateDoor_D1C1972F439274DEB3CACDACDF2093AC;                         // 0x06F8 (size: 0x4)
    TEnumAsByte<ETimelineDirection> ________Direction_D1C1972F439274DEB3CACDACDF2093AC; // 0x06FC (size: 0x1)

#ifndef UE4SS_SDK_BP_BuildObject_JapaneseStyle_DoorWall_02_HPP
#define UE4SS_SDK_BP_BuildObject_JapaneseStyle_DoorWall_02_HPP

class ABP_BuildObject_JapaneseStyle_DoorWall_02_C : public APalBuildObjectBasicBase
{
    ...
    class UStaticMeshComponent* Architecture_JapaneseStyle_DoorB_L;                   // 0x0698 (size: 0x8)
    class UStaticMeshComponent* Architecture_JapaneseStyle_DoorB_R;                   // 0x06A0 (size: 0x8)
    ...
    class UStaticMeshComponent* Architecture_JapaneseStyle_DoorB;                     // 0x06E0 (size: 0x8)
    class USceneComponent* Root;                                                      // 0x06E8 (size: 0x8)
    class UBoxComponent* CheckOverlapCollision;                                       // 0x06F0 (size: 0x8)
    float _______MoveDoor_7392E0CE4AC4E3CD92EEDE9F2EC60698;                           // 0x06F8 (size: 0x4)
    TEnumAsByte<ETimelineDirection> ________Direction_7392E0CE4AC4E3CD92EEDE9F2EC60698; // 0x06FC (size: 0x1)
    ...
    void ExecuteUbergraph_BP_BuildObject_JapaneseStyle_DoorWall_02(int32 EntryPoint);
}; // Size: 0x710

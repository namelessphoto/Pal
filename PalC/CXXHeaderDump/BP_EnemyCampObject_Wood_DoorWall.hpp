...
class ABP_EnemyCampObject_Wood_DoorWall_C : public APalBuildObjectBasicBase
{
    ...
    class UStaticMeshComponent* SM_Door_Wood;                                         // 0x06D0 (size: 0x8)
    class UBoxComponent* BuildWorkableBounds;                                         // 0x06D8 (size: 0x8)
    class UStaticMeshComponent* SM_Doorbase_Wood;                                     // 0x06E0 (size: 0x8)
    class USceneComponent* Root;                                                      // 0x06E8 (size: 0x8)
    class UBoxComponent* CheckOverlapCollision;                                       // 0x06F0 (size: 0x8)
    float _______RotateDoor_BB5364B1430E0226CCDF4AAA6074F427;                         // 0x06F8 (size: 0x4)
    TEnumAsByte<ETimelineDirection> ________Direction_BB5364B1430E0226CCDF4AAA6074F427; // 0x06FC (size: 0x1)

...
{
    FSkyCreatorSkyAtmosphereSettings SkyAtmosphereSettings;                           // 0x0000 (size: 0x80)
    FSkyCreatorVolumetricCloudSettings VolumetricCloudSettings;                       // 0x0080 (size: 0xA8)
    FSkyCreatorBackgroundCloudSettings BackgroundCloudSettings;                       // 0x0128 (size: 0x24)
    FSkyCreatorSkyLightSettings SkyLightSettings;                                     // 0x014C (size: 0x2C)
    FSkyCreatorSunLightSettings SunLightSettings;                                     // 0x0178 (size: 0x48)
    FSkyCreatorMoonLightSettings MoonLightSettings;                                   // 0x01C0 (size: 0x48)
    FSkyCreatorExponentialHeightFogSettings ExponentialHeightFogSettings;             // 0x0208 (size: 0x64)
    FSkyCreatorStarMapSettings StarMapSettings;                                       // 0x026C (size: 0x48)
    FSkyCreatorWeatherFXSettings WeatherFXSettings;                                   // 0x02B8 (size: 0x110)
    FSkyCreatorWeatherMaterialFXSettings WeatherMaterialFXSettings;                   // 0x03C8 (size: 0x68)
    FSkyCreatorWindSettings WindSettings;                                             // 0x0430 (size: 0x1C)
    FSkyCreatorPostProcessSettings PostProcessSettings;                               // 0x044C (size: 0xC)
...
class ASkyCreator : public AActor
{
    ...
    TEnumAsByte<ESkyCreatorEditorWeatherType> EditorWeatherType;                      // 0x0329 (size: 0x1)
    class USkyCreatorWeatherPreset* EditorWeatherPreset;                              // 0x0330 (size: 0x8)
    FSkyCreatorWeatherSettings EditorWeatherSettings;                                 // 0x0338 (size: 0x458)
    bool bIsUsedWithSequencer;                                                        // 0x0790 (size: 0x1)
    bool bIsEditorTickEnabled;                                                        // 0x0791 (size: 0x1)
    float TimeOfDay;                                                                  // 0x0794 (size: 0x4)
    FSkyCreatorWeatherSettings WeatherSettings;                                       // 0x0798 (size: 0x458)
    ...
    TEnumAsByte<ESkyCreatorSunPositionType> SunPositionType;                          // 0x0BFD (size: 0x1)
    FCelestialPositionData SunPositionData;                                           // 0x0C00 (size: 0x8)
    TEnumAsByte<ESkyCreatorMoonPositionType> MoonPositionType;                        // 0x0C08 (size: 0x1)
    FCelestialPositionData MoonPositionData;                                          // 0x0C0C (size: 0x8)
    ...
    TEnumAsByte<EComponentMobility> SkyAtmosphereMobility;                            // 0x0C9C (size: 0x1)
    ...
    TEnumAsByte<EVolumetricCloudRenderTargetMode> RenderMode;                         // 0x0D49 (size: 0x1)
    ...
    TEnumAsByte<EVolumetricCloudNoiseShapeResolution> NoiseShapeResolution;           // 0x0D84 (size: 0x1)
    TEnumAsByte<EVolumetricCloudNoiseDetailResolution> NoiseDetailResolution;         // 0x0D85 (size: 0x1)
    ...
    TEnumAsByte<EComponentMobility> SkyLightMobility;                                 // 0x0D9C (size: 0x1)
    ...
    TEnumAsByte<EComponentMobility> SunLightMobility;                                 // 0x0DB0 (size: 0x1)
    ...
    TEnumAsByte<EComponentMobility> MoonLightMobility;                                // 0x0DE8 (size: 0x1)
    ...
    TEnumAsByte<EComponentMobility> ExponentialHeightFogMobility;                     // 0x0E34 (size: 0x1)
    ...
    TEnumAsByte<ESkyCreatorStarMapRotationType> StarMapRotationType;                  // 0x0E48 (size: 0x1)
    ...
    TArray<FSkyCreatorLightningParameters> LightningParameters;                       // 0x0F58 (size: 0x10)
    ...
    FSkyCreatorWindSettings EditorIndependentWindSettings;                            // 0x1098 (size: 0x1C)
    ...
    FSkyCreatorOnLightningStrike OnLightningStrike;                                   // 0x1170 (size: 0x10)
...
class USkyCreatorWeatherPreset : public UDataAsset
{
    ...
    FSkyCreatorSkyAtmosphereSettings SkyAtmosphereSettings;                           // 0x0048 (size: 0x80)
    FSkyCreatorVolumetricCloudSettings VolumetricCloudSettings;                       // 0x00C8 (size: 0xA8)
    FSkyCreatorBackgroundCloudSettings BackgroundCloudSettings;                       // 0x0170 (size: 0x24)
    FSkyCreatorSkyLightSettings SkyLightSettings;                                     // 0x0194 (size: 0x2C)
    FSkyCreatorSunLightSettings SunLightSettings;                                     // 0x01C0 (size: 0x48)
    FSkyCreatorMoonLightSettings MoonLightSettings;                                   // 0x0208 (size: 0x48)
    FSkyCreatorExponentialHeightFogSettings ExponentialHeightFogSettings;             // 0x0250 (size: 0x64)
    FSkyCreatorStarMapSettings StarMapSettings;                                       // 0x02B4 (size: 0x48)
    FSkyCreatorWeatherFXSettings WeatherFXSettings;                                   // 0x0300 (size: 0x110)
    FSkyCreatorWeatherMaterialFXSettings WeatherMaterialFXSettings;                   // 0x0410 (size: 0x68)
    FSkyCreatorWindSettings WindSettings;                                             // 0x0478 (size: 0x1C)
    FSkyCreatorPostProcessSettings PostProcessSettings;                               // 0x0494 (size: 0xC)

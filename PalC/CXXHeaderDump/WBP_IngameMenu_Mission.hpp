...
class UWBP_IngameMenu_Mission_C : public UPalUIBaseCampTaskBase
{
    ...
    TArray<class UWBP_IngameMenu_MissionList_C*> MissionList;                         // 0x04E0 (size: 0x10)
    FPalBaseCampTaskCheckedData ChedckedData;                                         // 0x04F0 (size: 0x60)
    FPalBaseCampTaskDataSet TaskData;                                                 // 0x0550 (size: 0x28)
    FDataTableRowHandle BuildOBjectNumTaskInfoMsgID;                                  // 0x0578 (size: 0x10)
    FDataTableRowHandle WorkerNumTaskInfoMsgID;                                       // 0x0588 (size: 0x10)
    bool CanLevelup;                                                                  // 0x0598 (size: 0x1)
    int32 LastLevel;                                                                  // 0x059C (size: 0x4)
    FTimerHandle TaskUpdateTimer;                                                     // 0x05A0 (size: 0x8)
    bool ButtonActive;                                                                // 0x05A8 (size: 0x1)
    FDataTableRowHandle PalLimitMsgId;                                                // 0x05B0 (size: 0x10)

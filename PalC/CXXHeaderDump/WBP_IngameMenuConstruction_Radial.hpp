...
class UWBP_IngameMenuConstruction_Radial_C : public UPalUserWidget
{
    ...
    class UWBP_IngameMenuConstruction_Tab_C* WBP_IngameMenuConstruction_Tab_10;       // 0x04A0 (size: 0x8)
    ...
    FPalDataTableRowName_UIInputAction DecideMenuAction;                              // 0x04B8 (size: 0x8)
    FPalDataTableRowName_UIInputAction PrevTabActionName;                             // 0x04C0 (size: 0x8)
    FPalDataTableRowName_UIInputAction PrevTabActionName_Mouse;                       // 0x04C8 (size: 0x8)
    FPalDataTableRowName_UIInputAction NextTabActionName;                             // 0x04D0 (size: 0x8)
    FPalDataTableRowName_UIInputAction NextTabActionName_Mouse;                       // 0x04D8 (size: 0x8)
    TMap<class EPalBuildObjectTypeA, class bool> BuildObjectDataListMap;              // 0x04E0 (size: 0x50)
    class UBP_InGameMenuBuildModel_C* Model;                                          // 0x0530 (size: 0x8)
    TMap<class EPalBuildObjectTypeA, class UWBP_IngameMenuConstruction_Tab_C*> Tabs;  // 0x0538 (size: 0x50)
    int32 CurrentPageIndex;                                                           // 0x0588 (size: 0x4)
    EPalBuildObjectTypeA CurrentCategory;                                             // 0x058C (size: 0x1)
    int32 SelectedIndex;                                                              // 0x0590 (size: 0x4)
    TArray<FPalBuildObjectData> CurrentPageObjects;                                   // 0x0598 (size: 0x10)
    FWBP_IngameMenuConstruction_Radial_COnBuildModeStart OnBuildModeStart;            // 0x05A8 (size: 0x10)
    void OnBuildModeStart();
    FPalDataTableRowName_UIInputAction OpenDismantling;                               // 0x05B8 (size: 0x8)
    TArray<FPalUIActionBindData> ActionBindList;                                      // 0x05C0 (size: 0x10)
    FPalDataTableRowName_UIInputAction PrevCategoryAction;                            // 0x05D0 (size: 0x8)
    FPalDataTableRowName_UIInputAction NextCategoryAction;                            // 0x05D8 (size: 0x8)
    FName Flag Name;                                                                  // 0x05E0 (size: 0x8)
    TMap<class EPalBuildObjectTypeA, class FPalRadialCatalog> Catalogs;               // 0x05E8 (size: 0x50)
    TMap<EPalBuildObjectTypeA, int32> CatagoryIndex;                                  // 0x0638 (size: 0x50)
    TArray<FPalBuildObjectData> CurrentNewObjects;                                    // 0x0688 (size: 0x10)

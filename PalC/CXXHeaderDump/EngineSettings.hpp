...
class UGameMapsSettings : public UObject
{
    ...
    TEnumAsByte<ETwoPlayerSplitScreenType> TwoPlayerSplitscreenLayout;                // 0x0059 (size: 0x1)
    TEnumAsByte<EThreePlayerSplitScreenType> ThreePlayerSplitscreenLayout;            // 0x005A (size: 0x1)

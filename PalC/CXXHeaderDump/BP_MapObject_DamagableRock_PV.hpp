...
{
    class UBoxComponent* CheckOverlapCollision;                                       // 0x03F8 (size: 0x8)
    class UBoxComponent* WorkableBounds;                                              // 0x0400 (size: 0x8)
    class UArrowComponent* IndicatorOrigin;                                           // 0x0408 (size: 0x8)
    class UPalMapObjectDropItemParameterComponent* DropItemParameter;                 // 0x0410 (size: 0x8)

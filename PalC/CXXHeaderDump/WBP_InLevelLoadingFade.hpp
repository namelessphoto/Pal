...
class UWBP_InLevelLoadingFade_C : public UWBP_PalFadeWidgetBase_C
{
    ...
    class UBP_PalTextBlock_C* BP_PalTextBlock_Crossplay;                              // 0x0420 (size: 0x8)
    class UWBP_LoadingScreen_C* WBP_LoadingScreen;                                    // 0x0428 (size: 0x8)
    class UWBP_Title_ProgressBar_C* WBP_Title_ProgressBar;                            // 0x0430 (size: 0x8)
    int32 Step;                                                                       // 0x0438 (size: 0x4)
    bool ProgressDisplay;                                                             // 0x043C (size: 0x1)

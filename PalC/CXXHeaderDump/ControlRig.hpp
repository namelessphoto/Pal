...
struct FControlRigDrawInstruction
{
    ...
    TEnumAsByte<EControlRigDrawSettings> PrimitiveType;                               // 0x0008 (size: 0x1)
...
{
    TEnumAsByte<EAxis> MirrorAxis;                                                    // 0x0000 (size: 0x1)
    TEnumAsByte<EAxis> AxisToFlip;                                                    // 0x0001 (size: 0x1)
...
struct FRigTransformStackEntry
{
    ...
    TEnumAsByte<ERigTransformType> TransformType;                                     // 0x000D (size: 0x1)
...
struct FRigUnit_MathQuaternionGetAxis : public FRigUnit_MathQuaternionBase
{
    ...
    TEnumAsByte<EAxis> Axis;                                                          // 0x0030 (size: 0x1)
    FVector Result;                                                                   // 0x0038 (size: 0x18)
...
{
    FQuat Value;                                                                      // 0x0010 (size: 0x20)
    TEnumAsByte<EAxis> MirrorAxis;                                                    // 0x0030 (size: 0x1)
    TEnumAsByte<EAxis> AxisToFlip;                                                    // 0x0031 (size: 0x1)
...
{
    FTransform Value;                                                                 // 0x0010 (size: 0x60)
    TEnumAsByte<EAxis> Axis;                                                          // 0x0070 (size: 0x1)
    TEnumAsByte<EControlRigClampSpatialMode> Type;                                    // 0x0071 (size: 0x1)
...
{
    FTransform Value;                                                                 // 0x0010 (size: 0x60)
    TEnumAsByte<EAxis> MirrorAxis;                                                    // 0x0070 (size: 0x1)
    TEnumAsByte<EAxis> AxisToFlip;                                                    // 0x0071 (size: 0x1)
...
{
    FVector Value;                                                                    // 0x0008 (size: 0x18)
    TEnumAsByte<EAxis> Axis;                                                          // 0x0020 (size: 0x1)
    TEnumAsByte<EControlRigClampSpatialMode> Type;                                    // 0x0021 (size: 0x1)
...
{
    FVector Value;                                                                    // 0x0008 (size: 0x18)
    TEnumAsByte<EAxis> MirrorAxis;                                                    // 0x0020 (size: 0x1)
    TEnumAsByte<EAxis> AxisToFlip;                                                    // 0x0021 (size: 0x1)
...
class UControlRigPoseMirrorSettings : public UObject
{
    ...
    TEnumAsByte<EAxis> MirrorAxis;                                                    // 0x0048 (size: 0x1)
    TEnumAsByte<EAxis> AxisToFlip;                                                    // 0x0049 (size: 0x1)
...
{
    TEnumAsByte<ERigTransformType> TransformType;                                     // 0x00B0 (size: 0x1)

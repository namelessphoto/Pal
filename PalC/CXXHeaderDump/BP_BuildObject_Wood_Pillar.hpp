#ifndef UE4SS_SDK_BP_BuildObject_Wood_Pillar_HPP
#define UE4SS_SDK_BP_BuildObject_Wood_Pillar_HPP

class ABP_BuildObject_Wood_Pillar_C : public APalBuildObjectBasicBase
{
    ...
    class UStaticMeshComponent* StaticMesh;                                           // 0x06A0 (size: 0x8)

...
class UWBP_MainMenu_Tab_C : public UUserWidget
{
    ...
    TEnumAsByte<EPalUIInGameMainMenuTabType> BindMainMenuType;                        // 0x02D0 (size: 0x1)
    TMap<TEnumAsByte<EPalUIInGameMainMenuTabType>, FDataTableRowHandle> MsgIDMap;     // 0x02D8 (size: 0x50)

...
class UWBP_IngameMenu_Task_Simple_C : public UUserWidget
{
    ...
    class UBP_PalTextBlock_C* Text_WorkHardType;                                      // 0x0338 (size: 0x8)
    class UVerticalBox* VerticalBox_All;                                              // 0x0340 (size: 0x8)
    class UVerticalBox* VerticalBox_TaskDetail;                                       // 0x0348 (size: 0x8)
    class UWBP_IngameMenu_Task_SimpleList_C* WBP_IngameMenu_Task_SimpleList;          // 0x0350 (size: 0x8)
    class UWBP_IngameMenu_Task_SimpleList_C* WBP_IngameMenu_Task_SimpleList_1;        // 0x0358 (size: 0x8)
    class UWBP_IngameMenu_Task_SimpleList_C* WBP_IngameMenu_Task_SimpleList_2;        // 0x0360 (size: 0x8)
    class UWBP_IngameMenu_Task_SimpleList_C* WBP_IngameMenu_Task_SimpleList_3;        // 0x0368 (size: 0x8)
    class UWBP_IngameMenu_Task_SimpleList_C* WBP_IngameMenu_Task_SimpleList_4;        // 0x0370 (size: 0x8)
    class UWBP_IngameMenu_TaskMaterial_C* WBP_IngameMenu_TaskMaterial;                // 0x0378 (size: 0x8)
    class UWrapBox* WrapBox_ItemInfo;                                                 // 0x0380 (size: 0x8)
    TArray<class UWBP_IngameMenu_Task_SimpleList_C*> palDetailWidgetArray;            // 0x0388 (size: 0x10)
    FSlateFontInfo TaskDetailBaseFont;                                                // 0x0398 (size: 0x60)
    class UMaterial* completedTaskFontMaterial;                                       // 0x03F8 (size: 0x8)
    class UMaterial* incompletedTaskFontMaterial;                                     // 0x0400 (size: 0x8)
    FDataTableRowHandle buildTaskMsgID;                                               // 0x0408 (size: 0x10)
    FDataTableRowHandle workerTaskMsgID;                                              // 0x0418 (size: 0x10)
    TMap<class EPalBaseCampWorkerDirectionBattleType, class FDataTableRowHandle> BattleTypeMsgMap; // 0x0428 (size: 0x50)
    TMap<class EPalBaseCampWorkerDirectionBattleType, class TSoftObjectPtr<UTexture2D>> BattleTypeIconMap; // 0x0478 (size: 0x50)
    TMap<class EPalBaseCampPassiveEffectWorkHardType, class FDataTableRowHandle> WorkHardTypeMsgMap; // 0x04C8 (size: 0x50)
    TMap<class EPalBaseCampPassiveEffectWorkHardType, class TSoftObjectPtr<UTexture2D>> WorkHardTypeIconMap; // 0x0518 (size: 0x50)
    bool CollapseLastPal;                                                             // 0x0568 (size: 0x1)

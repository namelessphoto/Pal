...
class UWBP_IngameMenuConstruction_info_C : public UUserWidget
{
    ...
    class UImage* Image_278;                                                          // 0x02C8 (size: 0x8)
    class UBP_PalRichTextBlock_C* RichText_BuildObjectDesc;                           // 0x02D0 (size: 0x8)
    class UBP_PalTextBlock_C* Text_ManMonth_Value;                                    // 0x02D8 (size: 0x8)
    class UWBP_IngameMenuConstruction_InfoItem_C* WBP_IngameMenuConstruction_InfoItem; // 0x02E0 (size: 0x8)
    class UWBP_IngameMenuConstruction_InfoItem_C* WBP_IngameMenuConstruction_InfoItem_1; // 0x02E8 (size: 0x8)
    class UWBP_IngameMenuConstruction_InfoItem_C* WBP_IngameMenuConstruction_InfoItem_2; // 0x02F0 (size: 0x8)
    class UWBP_IngameMenuConstruction_InfoItem_C* WBP_IngameMenuConstruction_InfoItem_3; // 0x02F8 (size: 0x8)

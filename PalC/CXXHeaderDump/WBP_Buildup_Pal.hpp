...
class UWBP_Buildup_Pal_C : public UPalUserWidgetOverlayUI
{
    ...
    class UWBP_Buildup_Pal_Item_C* WBP_Buildup_Pal_Item_3;                            // 0x0460 (size: 0x8)
    class UWBP_Buildup_Pal_Status_C* WBP_Buildup_Pal_Status;                          // 0x0468 (size: 0x8)
    class UWBP_Buildup_TabButton_C* WBP_Buildup_TabButton_Reset;                      // 0x0470 (size: 0x8)
    class UWBP_Buildup_TabButton_C* WBP_Buildup_TabButton_Upgrade;                    // 0x0478 (size: 0x8)
    class UWBP_IngameMenu_PalBox_PalDetail_C* WBP_IngameMenu_PalBox_PalDetail;        // 0x0480 (size: 0x8)
    ...
    TArray<class UWBP_Menu_PalList_C*> PalList;                                       // 0x04C0 (size: 0x10)
    TArray<class UWBP_Buildup_Pal_Item_C*> UpgradeItems;                              // 0x04D0 (size: 0x10)
    TArray<FName> UpgradeItemIds;                                                     // 0x04E0 (size: 0x10)
    FDataTableRowHandle PreTabMsgId;                                                  // 0x04F0 (size: 0x10)
    FDataTableRowHandle NextTabMsgId;                                                 // 0x0500 (size: 0x10)
    class UPalIndividualCharacterHandle* CurrentHandle;                               // 0x0510 (size: 0x8)
    bool PinDetail;                                                                   // 0x0518 (size: 0x1)
    bool Hovering;                                                                    // 0x0519 (size: 0x1)
    int32 CurrentTab;                                                                 // 0x051C (size: 0x4)
    bool ResultSuccess;                                                               // 0x0520 (size: 0x1)
    bool Replicate_Status;                                                            // 0x0521 (size: 0x1)
    bool Requested;                                                                   // 0x0522 (size: 0x1)
    FTimerHandle ItemUpdateTimer;                                                     // 0x0528 (size: 0x8)

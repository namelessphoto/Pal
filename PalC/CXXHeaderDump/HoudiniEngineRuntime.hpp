...
{
    TArray<FString> Include;                                                          // 0x0000 (size: 0x10)
    TArray<FString> Exclude;                                                          // 0x0010 (size: 0x10)
...
struct FHImageData
{
    ...
    int32 NumSlices;                                                                  // 0x0008 (size: 0x4)
    uint8 Format;                                                                     // 0x000C (size: 0x1)
    uint8 GammaSpace;                                                                 // 0x000D (size: 0x1)
    TArray<uint8> RawData;                                                            // 0x0010 (size: 0x10)
    FString RawDataMD5;                                                               // 0x0020 (size: 0x10)
...
struct FHoudiniAssetBlueprintOutput
{
    ...
    FHoudiniOutputObject OutputObject;                                                // 0x0008 (size: 0x168)
...
struct FHoudiniBakedOutputObject
{
    ...
    FString Landscape;                                                                // 0x00E0 (size: 0x10)
    FString BakedSkeleton;                                                            // 0x00F0 (size: 0x10)
...
{
    TSet<FString> TargetLayers;                                                       // 0x0000 (size: 0x50)
...
struct FHoudiniDataLayer
{
    ...
    bool bCreateIfNeeded;                                                             // 0x0010 (size: 0x1)
...
struct FHoudiniGeoPartObject
{
    ...
    FString InstancerName;                                                            // 0x0108 (size: 0x10)
    bool bIsVisible;                                                                  // 0x0118 (size: 0x1)
    bool bIsEditable;                                                                 // 0x0119 (size: 0x1)
    bool bIsTemplated;                                                                // 0x011A (size: 0x1)
    bool bIsInstanced;                                                                // 0x011B (size: 0x1)
    bool bHasGeoChanged;                                                              // 0x011C (size: 0x1)
    bool bHasPartChanged;                                                             // 0x011D (size: 0x1)
    bool bHasTransformChanged;                                                        // 0x011E (size: 0x1)
    bool bHasMaterialsChanged;                                                        // 0x011F (size: 0x1)
    TArray<FHoudiniMeshSocket> AllMeshSockets;                                        // 0x02A0 (size: 0x10)
    TArray<FHoudiniGenericAttribute> GenericPropertyAttributes;                       // 0x02B0 (size: 0x10)
    bool bKeepTags;                                                                   // 0x02C0 (size: 0x1)
...
{
    EHoudiniXformType KeepWorldTransform;                                             // 0x0000 (size: 0x1)
    bool bImportAsReference;                                                          // 0x0001 (size: 0x1)
    bool bImportAsReferenceRotScaleEnabled;                                           // 0x0002 (size: 0x1)
    bool bImportAsReferenceBboxEnabled;                                               // 0x0003 (size: 0x1)
    bool bImportAsReferenceMaterialEnabled;                                           // 0x0004 (size: 0x1)
    bool bExportLODs;                                                                 // 0x0005 (size: 0x1)
    bool bExportSockets;                                                              // 0x0006 (size: 0x1)
    bool bPreferNaniteFallbackMesh;                                                   // 0x0007 (size: 0x1)
    bool bExportColliders;                                                            // 0x0008 (size: 0x1)
    bool bExportMaterialParameters;                                                   // 0x0009 (size: 0x1)
    bool bAddRotAndScaleAttributesOnCurves;                                           // 0x000A (size: 0x1)
    bool bUseLegacyInputCurves;                                                       // 0x000B (size: 0x1)
    float UnrealSplineResolution;                                                     // 0x000C (size: 0x4)
    EHoudiniLandscapeExportType LandscapeExportType;                                  // 0x0010 (size: 0x1)
    bool bLandscapeExportSelectionOnly;                                               // 0x0011 (size: 0x1)
    bool bLandscapeAutoSelectComponent;                                               // 0x0012 (size: 0x1)
    bool bLandscapeExportMaterials;                                                   // 0x0013 (size: 0x1)
    bool bLandscapeExportLighting;                                                    // 0x0014 (size: 0x1)
    bool bLandscapeExportNormalizedUVs;                                               // 0x0015 (size: 0x1)
    bool bLandscapeExportTileUVs;                                                     // 0x0016 (size: 0x1)
    bool bLandscapeAutoSelectSplines;                                                 // 0x0017 (size: 0x1)
    bool bLandscapeSplinesExportControlPoints;                                        // 0x0018 (size: 0x1)
    bool bLandscapeSplinesExportLeftRightCurves;                                      // 0x0019 (size: 0x1)
    bool bLandscapeSplinesExportSplineMeshComponents;                                 // 0x001A (size: 0x1)
    bool bMergeSplineMeshComponents;                                                  // 0x001B (size: 0x1)
    bool bExportHeightDataPerEditLayer;                                               // 0x001C (size: 0x1)
    bool bExportPaintLayersPerEditLayer;                                              // 0x001D (size: 0x1)
    bool bExportMergedPaintLayers;                                                    // 0x001E (size: 0x1)
    bool bExportLevelInstanceContent;                                                 // 0x001F (size: 0x1)
...
struct FHoudiniLevelInstanceParams
{
    ...
    FString OutputName;                                                               // 0x0008 (size: 0x10)

}; // Size: 0x18

struct FHoudiniMaterialIdentifier
{
    FString MaterialObjectPath;                                                       // 0x0008 (size: 0x10)
    bool bIsHoudiniMaterial;                                                          // 0x0018 (size: 0x1)
    bool bMakeMaterialInstance;                                                       // 0x0019 (size: 0x1)
    FString MaterialInstanceParametersSlug;                                           // 0x0020 (size: 0x10)
...
struct FHoudiniOutputObject
{
    ...
    bool bProxyIsCurrent;                                                             // 0x0040 (size: 0x1)
    bool bIsImplicit;                                                                 // 0x0041 (size: 0x1)
    bool bIsInvisibleCollisionMesh;                                                   // 0x0042 (size: 0x1)
    bool bIsGeometryCollectionPiece;                                                  // 0x0043 (size: 0x1)
    ...
    TArray<FHoudiniDataLayer> DataLayers;                                             // 0x0130 (size: 0x10)
    TArray<FHoudiniHLODLayer> HLODLayers;                                             // 0x0140 (size: 0x10)
    FHoudiniLevelInstanceParams LevelInstanceParams;                                  // 0x0150 (size: 0x18)
...
{
    TArray<FUserPackageRules> Packages;                                               // 0x0000 (size: 0x10)

}; // Size: 0x10

struct FUserPackageRules
{
    class UHoudiniToolsPackageAsset* ToolsPackageAsset;                               // 0x0000 (size: 0x8)
    TArray<FString> Include;                                                          // 0x0008 (size: 0x10)
    TArray<FString> Exclude;                                                          // 0x0018 (size: 0x10)
...
class UHoudiniAssetComponent : public UPrimitiveComponent
{
    ...
    bool bUseDeprecatedRawMeshSupport;                                                // 0x0570 (size: 0x1)
    bool bSplitMeshSupport;                                                           // 0x0571 (size: 0x1)
    ...
    bool bBakeAfterNextCook;                                                          // 0x09A9 (size: 0x1)
    EHoudiniBakeAfterNextCook BakeAfterNextCook;                                      // 0x09AA (size: 0x1)
    bool bCachedIsPreview;                                                            // 0x0A58 (size: 0x1)
    double LastTickTime;                                                              // 0x0A60 (size: 0x8)
...
class UHoudiniInput : public UObject
{
    ...
    bool bDirectlyConnectHdas;                                                        // 0x00CB (size: 0x1)
    bool bExportOptionsMenuExpanded;                                                  // 0x00CC (size: 0x1)
    bool bGeometryInputsMenuExpanded;                                                 // 0x00CD (size: 0x1)
    bool bLandscapeOptionsMenuExpanded;                                               // 0x00CE (size: 0x1)
    bool bWorldInputsMenuExpanded;                                                    // 0x00CF (size: 0x1)
    bool bCurveInputsMenuExpanded;                                                    // 0x00D0 (size: 0x1)
    bool bCurvePointSelectionMenuExpanded;                                            // 0x00D1 (size: 0x1)
    ...
    bool bLandscapeControlVisiblity;                                                  // 0x0243 (size: 0x1)
    bool bLandscapeAutoSelectComponent;                                               // 0x0244 (size: 0x1)
    bool bLandscapeExportMaterials;                                                   // 0x0245 (size: 0x1)
    bool bLandscapeExportLighting;                                                    // 0x0246 (size: 0x1)
    bool bLandscapeExportNormalizedUVs;                                               // 0x0247 (size: 0x1)
    bool bLandscapeExportTileUVs;                                                     // 0x0248 (size: 0x1)
    bool bCanDeleteHoudiniNodes;                                                      // 0x0249 (size: 0x1)
    bool bLandscapeAutoSelectSplines;                                                 // 0x024A (size: 0x1)
    bool bLandscapeSplinesExportOptionsMenuExpanded;                                  // 0x024B (size: 0x1)
    bool bLandscapeSplinesExportControlPoints;                                        // 0x024C (size: 0x1)
    bool bLandscapeSplinesExportLeftRightCurves;                                      // 0x024D (size: 0x1)
    bool bLandscapeSplinesExportSplineMeshComponents;                                 // 0x024E (size: 0x1)
    bool bMergeSplineMeshComponents;                                                  // 0x024F (size: 0x1)
    FHoudiniInputObjectSettings InputSettings;                                        // 0x0250 (size: 0x20)
...
class UHoudiniInputActor : public UHoudiniInputObject
{
    ...
    FGuid GeneratedSplinesMeshPackageGuid;                                            // 0x039C (size: 0x10)
    class UStaticMesh* GeneratedSplinesMesh;                                          // 0x03B0 (size: 0x8)
    bool bUsedMergeSplinesMeshAtLastTranslate;                                        // 0x03B8 (size: 0x1)
...
{
    TArray<FHoudiniBrushInfo> BrushesInfo;                                            // 0x03C0 (size: 0x10)
    class UModel* CombinedModel;                                                      // 0x03D0 (size: 0x8)
    bool bIgnoreInputObject;                                                          // 0x03D8 (size: 0x1)
    TEnumAsByte<EBrushType> CachedInputBrushType;                                     // 0x03D9 (size: 0x1)

}; // Size: 0x3E0

class UHoudiniInputCameraComponent : public UHoudiniInputSceneComponent
{
    float FOV;                                                                        // 0x0298 (size: 0x4)
    float AspectRatio;                                                                // 0x029C (size: 0x4)
    bool bIsOrthographic;                                                             // 0x02A0 (size: 0x1)
    float OrthoWidth;                                                                 // 0x02A4 (size: 0x4)
    float OrthoNearClipPlane;                                                         // 0x02A8 (size: 0x4)
    float OrthoFarClipPlane;                                                          // 0x02AC (size: 0x4)
...
{
    int32 AssetOutputIndex;                                                           // 0x0230 (size: 0x4)
    int32 AssetId;                                                                    // 0x0234 (size: 0x4)

}; // Size: 0x240

class UHoudiniInputHoudiniSplineComponent : public UHoudiniInputObject
{
    EHoudiniCurveType CurveType;                                                      // 0x0230 (size: 0x1)
    EHoudiniCurveMethod CurveMethod;                                                  // 0x0231 (size: 0x1)
    bool Reversed;                                                                    // 0x0232 (size: 0x1)
    class UHoudiniSplineComponent* CachedComponent;                                   // 0x0238 (size: 0x8)

}; // Size: 0x240

class UHoudiniInputInstancedMeshComponent : public UHoudiniInputMeshComponent
{
    TArray<FTransform> InstanceTransforms;                                            // 0x02C8 (size: 0x10)

}; // Size: 0x2E0

class UHoudiniInputLandscape : public UHoudiniInputActor
{
    int32 CachedNumLandscapeComponents;                                               // 0x03C0 (size: 0x4)
...
{
    TArray<FHoudiniLandscapeSplineControlPointData> CachedControlPoints;              // 0x0298 (size: 0x10)
    TArray<FHoudiniLandscapeSplineSegmentData> CachedSegments;                        // 0x02A8 (size: 0x10)
    TMap<TSoftObjectPtr<ULandscapeSplineControlPoint>, int32> ControlPointIdMap;      // 0x02B8 (size: 0x50)
    int32 NextControlPointId;                                                         // 0x0308 (size: 0x4)
...
class UHoudiniInputObject : public UObject
{
    ...
    bool bNeedsToTriggerUpdate;                                                       // 0x0169 (size: 0x1)
    bool bTransformChanged;                                                           // 0x016A (size: 0x1)
    TArray<FString> MaterialReferences;                                               // 0x0170 (size: 0x10)
    FHoudiniInputObjectSettings CachedInputSettings;                                  // 0x0180 (size: 0x20)
    bool bCanDeleteHoudiniNodes;                                                      // 0x01A0 (size: 0x1)
    bool bInputNodeHandleOverridesNodeIds;                                            // 0x01A1 (size: 0x1)
    FTransform Transform;                                                             // 0x01B0 (size: 0x60)
    FRotator UserInputRotator;                                                        // 0x0210 (size: 0x18)
    int32 InputNodeId;                                                                // 0x0228 (size: 0x4)
    int32 InputObjectNodeId;                                                          // 0x022C (size: 0x4)

}; // Size: 0x230

class UHoudiniInputPackedLevelActor : public UHoudiniInputActor
{
    class UHoudiniInputBlueprint* BlueprintInputObject;                               // 0x03C0 (size: 0x8)

}; // Size: 0x3D0

class UHoudiniInputSceneComponent : public UHoudiniInputObject
{
    FTransform ActorTransform;                                                        // 0x0230 (size: 0x60)
    class UHoudiniInputActor* ParentInputActor;                                       // 0x0290 (size: 0x8)
...
{
    int32 NumberOfSplineControlPoints;                                                // 0x0298 (size: 0x4)
    float SplineLength;                                                               // 0x029C (size: 0x4)
    float SplineResolution;                                                           // 0x02A0 (size: 0x4)
    bool SplineClosed;                                                                // 0x02A4 (size: 0x1)
    TArray<FTransform> SplineControlPoints;                                           // 0x02A8 (size: 0x10)

}; // Size: 0x2C0

class UHoudiniInputSplineMeshComponent : public UHoudiniInputMeshComponent
{
    FGuid MeshPackageGuid;                                                            // 0x02C8 (size: 0x10)
    class UStaticMesh* GeneratedMesh;                                                 // 0x02D8 (size: 0x8)
    TEnumAsByte<ESplineMeshAxis> CachedForwardAxis;                                   // 0x02E0 (size: 0x1)
    FSplineMeshParams CachedSplineParams;                                             // 0x02E8 (size: 0xB0)
    FVector CachedSplineUpDir;                                                        // 0x0398 (size: 0x18)
    float CachedSplineBoundaryMax;                                                    // 0x03B0 (size: 0x4)
    float CachedSplineBoundaryMin;                                                    // 0x03B4 (size: 0x4)
    uint8 CachedbSmoothInterpRollScale;                                               // 0x03B8 (size: 0x1)
...
class UHoudiniLandscapeTargetLayerOutput : public UObject
{
    class ALandscape* Landscape;                                                      // 0x0028 (size: 0x8)
    class ALandscapeProxy* LandscapeProxy;                                            // 0x0030 (size: 0x8)
    FString BakedEditLayer;                                                           // 0x0038 (size: 0x10)
    FString CookedEditLayer;                                                          // 0x0048 (size: 0x10)
    FString TargetLayer;                                                              // 0x0058 (size: 0x10)
    FHoudiniExtents Extents;                                                          // 0x0068 (size: 0x10)
    bool bClearLayer;                                                                 // 0x0078 (size: 0x1)
    ...
    bool bLockLayer;                                                                  // 0x00B9 (size: 0x1)
    TArray<FHoudiniGenericAttribute> PropertyAttributes;                              // 0x00C0 (size: 0x10)
...
{
    FString FetchNodePath;                                                            // 0x0A90 (size: 0x10)
    bool bLiveSyncEnabled;                                                            // 0x0AA0 (size: 0x1)
...
class UHoudiniOutput : public UObject
{
    ...
    bool bCanDeleteHoudiniNodes;                                                      // 0x024B (size: 0x1)
...
class UHoudiniPDGAssetLink : public UObject
{
    ...
    int32 NumAttemptedNodeAutoBakes;                                                  // 0x0130 (size: 0x4)
    int32 NumSuccessfulNodeAutoBakes;                                                 // 0x0134 (size: 0x4)
...
class UHoudiniParameter : public UObject
{
    ...
    EHoudiniParameterChoiceListType ChoiceListType;                                   // 0x0049 (size: 0x1)
    ...
    bool bIsLabelVisible;                                                             // 0x0068 (size: 0x1)
    bool bIsChildOfMultiParm;                                                         // 0x0069 (size: 0x1)
    bool bIsDirectChildOfMultiParm;                                                   // 0x006A (size: 0x1)
    bool bPendingRevertToDefault;                                                     // 0x006B (size: 0x1)
...
{
    TArray<FString> Labels;                                                           // 0x0108 (size: 0x10)
    uint32 Value;                                                                     // 0x0118 (size: 0x4)
    uint32 DefaultValue;                                                              // 0x011C (size: 0x4)
...
class UHoudiniRuntimeSettings : public UObject
{
    ...
    TArray<FString> HoudiniToolsSearchPath;                                           // 0x02B8 (size: 0x10)
    bool bUseCustomHoudiniLocation;                                                   // 0x02C8 (size: 0x1)
    FDirectoryPath CustomHoudiniLocation;                                             // 0x02D0 (size: 0x10)
    TEnumAsByte<EHoudiniExecutableType> HoudiniExecutable;                            // 0x02E0 (size: 0x1)
    FDirectoryPath CustomHoudiniHomeLocation;                                         // 0x02E8 (size: 0x10)
    int32 CookingThreadStackSize;                                                     // 0x02F8 (size: 0x4)
    FString HoudiniEnvironmentFiles;                                                  // 0x0300 (size: 0x10)
    FString OtlSearchPath;                                                            // 0x0310 (size: 0x10)
    FString DsoSearchPath;                                                            // 0x0320 (size: 0x10)
    FString ImageDsoSearchPath;                                                       // 0x0330 (size: 0x10)
    FString AudioDsoSearchPath;                                                       // 0x0340 (size: 0x10)
...
class UHoudiniSplineComponent : public USceneComponent
{
    ...
    bool bHasChanged;                                                                 // 0x05D0 (size: 0x1)
    bool bNeedsToTriggerUpdate;                                                       // 0x05D1 (size: 0x1)
    bool bIsInputCurve;                                                               // 0x05D2 (size: 0x1)
    bool bIsEditableOutputCurve;                                                      // 0x05D3 (size: 0x1)
    int32 NodeID;                                                                     // 0x05D4 (size: 0x4)
    FString PartName;                                                                 // 0x05D8 (size: 0x10)
...
class UHoudiniStaticMesh : public UObject
{
    ...
    TArray<FVector2f> VertexInstanceUVs;                                              // 0x0098 (size: 0x10)
...
class UHoudiniToolData : public UObject
{
    ...
    FHImageData IconImageData;                                                        // 0x0048 (size: 0x30)
    FFilePath IconSourcePath;                                                         // 0x0078 (size: 0x10)
    FString HelpURL;                                                                  // 0x0088 (size: 0x10)
    EHoudiniToolType Type;                                                            // 0x0098 (size: 0x1)
    bool DefaultTool;                                                                 // 0x0099 (size: 0x1)
    EHoudiniToolSelectionType SelectionType;                                          // 0x009A (size: 0x1)
    FFilePath SourceAssetPath;                                                        // 0x00A0 (size: 0x10)
...
class UHoudiniToolsPackageAsset : public UObject
{
    ...
    bool bReimportToolsDescription;                                                   // 0x008A (size: 0x1)
    bool bExportToolsDescription;                                                     // 0x008B (size: 0x1)
...
class UTOPNode : public UObject
{
    ...
    FOutputActorOwner OutputActorOwner;                                               // 0x03E0 (size: 0x10)

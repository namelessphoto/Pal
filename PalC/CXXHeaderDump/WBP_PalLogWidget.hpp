...
class UWBP_PalLogWidget_C : public UPalLogWidget
{
    ...
    class UScrollBox* ScrollBox_NormalLog;                                            // 0x0428 (size: 0x8)
    class UVerticalBox* VerticalBox_KillDeathLog;                                     // 0x0430 (size: 0x8)
    ...
    TArray<class UWBP_Notice_Deathlog_C*> KillLogList;                                // 0x0530 (size: 0x10)

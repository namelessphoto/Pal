...
struct FNiagaraOutlinerSystemInstanceData
{
    ...
    TEnumAsByte<ENiagaraGpuComputeTickStage> GpuTickStage;                            // 0x005D (size: 0x1)
...
class UNiagaraDataInterfaceAsyncGpuTrace : public UNiagaraDataInterface
{
    ...
    TEnumAsByte<ENDICollisionQuery_AsyncGpuTraceProvider> TraceProvider;              // 0x0040 (size: 0x1)
...
class UNiagaraSettings : public UDeveloperSettings
{
    ...
    TEnumAsByte<ENDISkelMesh_GpuMaxInfluences> NDISkelMesh_GpuMaxInfluences;          // 0x00E0 (size: 0x1)
    TEnumAsByte<ENDISkelMesh_GpuUniformSamplingFormat> NDISkelMesh_GpuUniformSamplingFormat; // 0x00E1 (size: 0x1)
    TEnumAsByte<ENDISkelMesh_AdjacencyTriangleIndexFormat> NDISkelMesh_AdjacencyTriangleIndexFormat; // 0x00E2 (size: 0x1)
    bool NDIStaticMesh_AllowDistanceFields;                                           // 0x00E3 (size: 0x1)
    TArray<TEnumAsByte<ENDICollisionQuery_AsyncGpuTraceProvider>> NDICollisionQuery_AsyncGpuTraceProviderOrder; // 0x00E8 (size: 0x10)

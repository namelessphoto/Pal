...
class UWBP_Ingame_Incubator_C : public UPalUIMapObjectStatusIndicatorBase
{
    ...
    class UImage* CircleGauge_Complete;                                               // 0x0458 (size: 0x8)
    class UImage* CircleGauge_Progress;                                               // 0x0460 (size: 0x8)
    class UHorizontalBox* HorizontalBox_RemainTime;                                   // 0x0468 (size: 0x8)
    class UOverlay* OverlayBuff;                                                      // 0x0470 (size: 0x8)
    class UOverlay* OverlayStatus;                                                    // 0x0478 (size: 0x8)
    class UImage* StatusBase;                                                         // 0x0480 (size: 0x8)
    class UBP_PalTextBlock_C* Text_Buff_Value;                                        // 0x0488 (size: 0x8)
    class UBP_PalTextBlock_C* Text_EggName;                                           // 0x0490 (size: 0x8)
    class UBP_PalTextBlock_C* Text_Status;                                            // 0x0498 (size: 0x8)
    ...
    class UPalMapObjectHatchingEggModel* Model;                                       // 0x04B0 (size: 0x8)
    int32 LastNum;                                                                    // 0x04B8 (size: 0x4)
    FDataTableRowHandle UnusedMsgId;                                                  // 0x04C0 (size: 0x10)
    FDataTableRowHandle completeMsgID;                                                // 0x04D0 (size: 0x10)
    FTimerHandle DisplayCheckTimer;                                                   // 0x04E0 (size: 0x8)
    bool isDisplayedDetail;                                                           // 0x04E8 (size: 0x1)
    FName CachedItemId;                                                               // 0x04EC (size: 0x8)
    TArray<FDataTableRowHandle> TemperatureMsgIds;                                    // 0x04F8 (size: 0x10)
    bool HasEgg;                                                                      // 0x0508 (size: 0x1)
    bool HasChara;                                                                    // 0x0509 (size: 0x1)
    bool LackPower;                                                                   // 0x050A (size: 0x1)

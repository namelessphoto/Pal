#ifndef UE4SS_SDK_BP_EnemyCampObject_JapaneseStyle_DoorWall_02_HPP
#define UE4SS_SDK_BP_EnemyCampObject_JapaneseStyle_DoorWall_02_HPP

class ABP_EnemyCampObject_JapaneseStyle_DoorWall_02_C : public APalBuildObjectBasicBase
{
    ...
    class UStaticMeshComponent* Architecture_JapaneseStyle_DoorB_L;                   // 0x06A0 (size: 0x8)
    class UStaticMeshComponent* Architecture_JapaneseStyle_DoorB_R;                   // 0x06A8 (size: 0x8)
    class UBoxComponent* AffectNavigationBox;                                         // 0x06B0 (size: 0x8)
    class UBoxComponent* FrameCollision_02;                                           // 0x06B8 (size: 0x8)
    class UBoxComponent* FrameCollision_01;                                           // 0x06C0 (size: 0x8)
    class USceneComponent* FrameCollision;                                            // 0x06C8 (size: 0x8)
    class UBP_InteractableBox_C* BP_InteractableBox;                                  // 0x06D0 (size: 0x8)
    class UBoxComponent* DoorCollision;                                               // 0x06D8 (size: 0x8)
    class UBoxComponent* BuildWorkableBounds;                                         // 0x06E0 (size: 0x8)
    class UStaticMeshComponent* Architecture_JapaneseStyle_DoorB;                     // 0x06E8 (size: 0x8)
    class USceneComponent* Root;                                                      // 0x06F0 (size: 0x8)
    class UBoxComponent* CheckOverlapCollision;                                       // 0x06F8 (size: 0x8)
    float _______MoveDoor_5939C7C34381D884EFEC78991B9DA217;                           // 0x0700 (size: 0x4)
    TEnumAsByte<ETimelineDirection> ________Direction_5939C7C34381D884EFEC78991B9DA217; // 0x0704 (size: 0x1)
    ...
    void ExecuteUbergraph_BP_EnemyCampObject_JapaneseStyle_DoorWall_02(int32 EntryPoint);
}; // Size: 0x718

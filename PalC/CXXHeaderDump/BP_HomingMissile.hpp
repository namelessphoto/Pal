...
class ABP_HomingMissile_C : public ABP_AttackBulletBase_C
{
    ...
    class UStaticMeshComponent* SM_MissileExhaust;                                    // 0x0420 (size: 0x8)
    class UStaticMeshComponent* SM_Missile;                                           // 0x0428 (size: 0x8)
    bool IsExprosed;                                                                  // 0x0430 (size: 0x1)
    double HomingStartRandimTimeMin;                                                  // 0x0438 (size: 0x8)
    double HpmingAccele;                                                              // 0x0440 (size: 0x8)

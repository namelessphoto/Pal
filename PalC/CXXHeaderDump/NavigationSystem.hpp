...
struct FRecastNavMeshGenerationProperties
{
    ...
    TEnumAsByte<ERecastPartitioning> RegionPartitioning;                              // 0x0030 (size: 0x1)
    TEnumAsByte<ERecastPartitioning> LayerPartitioning;                               // 0x0031 (size: 0x1)
...
class ANavigationTestingActor : public AActor
{
    ...
    TEnumAsByte<ENavCostDisplay> CostDisplayMode;                                     // 0x0338 (size: 0x1)
...
class ARecastNavMesh : public ANavigationData
{
    ...
    TEnumAsByte<ERecastPartitioning> RegionPartitioning;                              // 0x053C (size: 0x1)
    TEnumAsByte<ERecastPartitioning> LayerPartitioning;                               // 0x053D (size: 0x1)
...
class UNavLinkCustomComponent : public UNavRelevantComponent
{
    ...
    TEnumAsByte<ENavLinkDirection> LinkDirection;                                     // 0x0148 (size: 0x1)
...
class UNavigationPath : public UObject
{
    ...
    void OnNavigationPathUpdated(class UNavigationPath* AffectedPath, TEnumAsByte<ENavPathEvent> PathEvent);
    TArray<FVector> PathPoints;                                                       // 0x0038 (size: 0x10)
    TEnumAsByte<ENavigationOptionFlag> RecalculateOnInvalidation;                     // 0x0048 (size: 0x1)
...
class UNavigationSystemV1 : public UNavigationSystemBase
{
    ...
    TEnumAsByte<ENavigationQueryResult> GetPathLength(class UObject* WorldContextObject, const FVector& PathStart, const FVector& PathEnd, float& PathLength, class ANavigationData* NavData, TSubclassOf<class UNavigationQueryFilter> FilterClass);
    TEnumAsByte<ENavigationQueryResult> GetPathCost(class UObject* WorldContextObject, const FVector& PathStart, const FVector& PathEnd, float& PathCost, class ANavigationData* NavData, TSubclassOf<class UNavigationQueryFilter> FilterClass);

#ifndef UE4SS_SDK_BP_BuildObject_Stone_TriangleWall_HPP
#define UE4SS_SDK_BP_BuildObject_Stone_TriangleWall_HPP

class ABP_BuildObject_Stone_TriangleWall_C : public APalBuildObjectBasicBase
{
    ...
    class UStaticMeshComponent* SM_Wall_Stone;                                        // 0x06A0 (size: 0x8)

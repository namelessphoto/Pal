...
struct FLimbSolverSettings
{
    ...
    TEnumAsByte<EAxis> HingeRotationAxis;                                             // 0x0004 (size: 0x1)
    ...
    TEnumAsByte<EAxis> EndBoneForwardAxis;                                            // 0x0021 (size: 0x1)
...
class UIKRig_LimbSolver : public UIKRigSolver
{
    ...
    TEnumAsByte<EAxis> HingeRotationAxis;                                             // 0x003C (size: 0x1)
    ...
    TEnumAsByte<EAxis> EndBoneForwardAxis;                                            // 0x0059 (size: 0x1)

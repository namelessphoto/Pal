...
class UWBP_IngameCommonSelectNum_C : public UPalUserWidget
{
    ...
    class UWBP_IngameMenu_WorkSpace_Slider_C* WBP_IngameMenu_WorkSpace_Slider;        // 0x04F8 (size: 0x8)
    ...
    int32 MinDisplayDigit;                                                            // 0x0510 (size: 0x4)
    TArray<class UBP_PalTextBlock_C*> NumTextArray;                                   // 0x0518 (size: 0x10)
    TArray<class USizeBox*> SizeBoxArray;                                             // 0x0528 (size: 0x10)
    int32 DoubleArrowNum;                                                             // 0x0538 (size: 0x4)
    int64 nowNum;                                                                     // 0x0540 (size: 0x8)
    FPalUIActionBindData RightDoubleArrowInputHandle;                                 // 0x0548 (size: 0x4)
    FPalUIActionBindData LeftDoubleArrowInputHandle;                                  // 0x054C (size: 0x4)
    FPalUIActionBindData RightArrowInputHandle;                                       // 0x0550 (size: 0x4)
    FPalUIActionBindData LeftArrowInputHandle;                                        // 0x0554 (size: 0x4)
    int64 Max Num;                                                                    // 0x0558 (size: 0x8)
    FWBP_IngameCommonSelectNum_COnUpdateNum OnUpdateNum;                              // 0x0560 (size: 0x10)
    void OnUpdateNum(int64 Num);
    FPalUIActionBindData MaxSelectInputHandle;                                        // 0x0570 (size: 0x4)
    int64 MinNum;                                                                     // 0x0578 (size: 0x8)

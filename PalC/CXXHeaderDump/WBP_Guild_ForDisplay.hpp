...
class UWBP_Guild_ForDisplay_C : public UPalUIGuildMenu
{
    ...
    TMap<TEnumAsByte<E_PalUIGuildMenuLogCategory>, FDataTableRowHandle> GuildLogCategoryTextMap; // 0x0460 (size: 0x50)
    TMap<FString, TEnumAsByte<E_PalUIGuildMenuLogCategory>> GuildLogStringCategoryMap; // 0x04B0 (size: 0x50)

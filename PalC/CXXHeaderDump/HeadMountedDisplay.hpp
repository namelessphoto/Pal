...
class UHeadMountedDisplayFunctionLibrary : public UBlueprintFunctionLibrary
{
    ...
    bool GetTrackingOriginTransform(TEnumAsByte<EHMDTrackingOrigin> Origin, FTransform& OutTransform);
    ...
    FVector2D GetPlayAreaBounds(TEnumAsByte<EHMDTrackingOrigin> Origin);
    ...
    TEnumAsByte<EXRDeviceConnectionResult> ConnectRemoteXRDevice(FString ipAddress, const int32 BitRate);

...
class UCommonButtonBase : public UCommonUserWidget
{
    ...
    TEnumAsByte<EButtonClickMethod> ClickMethod;                                      // 0x034A (size: 0x1)
    TEnumAsByte<EButtonTouchMethod> TouchMethod;                                      // 0x034B (size: 0x1)
    TEnumAsByte<EButtonPressMethod> PressMethod;                                      // 0x034C (size: 0x1)

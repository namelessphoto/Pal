#ifndef UE4SS_SDK_ABP_DarkMutant_Implementation_HPP
#define UE4SS_SDK_ABP_DarkMutant_Implementation_HPP
...
class UABP_DarkMutant_Implementation_C : public UPalAnimInstance
{
    ...
    void ExecuteUbergraph_ABP_DarkMutant_Implementation(int32 EntryPoint);
};

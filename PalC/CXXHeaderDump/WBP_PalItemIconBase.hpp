...
class UWBP_PalItemIconBase_C : public UPalUserWidget
{
    ...
    void OnSetEmpty();
    FWBP_PalItemIconBase_COnEnableBPIcon OnEnableBPIcon;                              // 0x0440 (size: 0x10)
    void OnEnableBPIcon(TSoftObjectPtr<UTexture2D> Icon);
    FWBP_PalItemIconBase_COnDisableBPIcon OnDisableBPIcon;                            // 0x0450 (size: 0x10)
    void OnDisableBPIcon();
    FName CurrentItemId;                                                              // 0x0460 (size: 0x8)

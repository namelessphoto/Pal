...
class UWBP_MenuESCPlayerListItem_C : public UUserWidget
{
    ...
    FWBP_MenuESCPlayerListItem_COnClicked OnClicked;                                  // 0x02F8 (size: 0x10)
    void OnClicked(class UWBP_Guild_MemberList_C* Widget);
    FPalUIGuildMemberDisplayInfo MyDisplayInfo;                                       // 0x0308 (size: 0x18)
    FWBP_MenuESCPlayerListItem_COnHovered OnHovered;                                  // 0x0320 (size: 0x10)
    ...
    FWBP_MenuESCPlayerListItem_COnRightClicked OnRightClicked;                        // 0x0368 (size: 0x10)
    void OnRightClicked(class UWBP_MenuESCPlayerListItem_C* ButtonBase);
    FString Display Player Name;                                                      // 0x0378 (size: 0x10)
    bool IsSamePlatform;                                                              // 0x0388 (size: 0x1)

...
class ABP_MonsterAIController_BaseCamp_C : public ABP_MonsterAIControllerBase_C
{
    ...
    FVector SpawnedPosition;                                                          // 0x0568 (size: 0x18)
    ...
    void SetAction_WorkerEvent(class UPalAIActionBase* action, TEnumAsByte<EAIRequestPriority> Priority);
    ...
    void SetAction_BaseCamp(TSubclassOf<class UPalAIActionBaseCampBase> AIActionClass, TEnumAsByte<EAIRequestPriority> Priority, class UPalAIActionBaseCampBase*& action);
    ...
    void InterruptPlayWorkerEventAction(class UPalAIActionBase* action, const TEnumAsByte<EAIRequestPriority> Priority);

...
class ABP_EnemyCampObject_JapaneseStyle_DoorWall_03_C : public APalBuildObjectBasicBase
{
    ...
    float _______MoveDoor_47F18B2F47CBAEE2EA9B9BABABEB5C5B;                           // 0x0700 (size: 0x4)
    TEnumAsByte<ETimelineDirection> ________Direction_47F18B2F47CBAEE2EA9B9BABABEB5C5B; // 0x0704 (size: 0x1)

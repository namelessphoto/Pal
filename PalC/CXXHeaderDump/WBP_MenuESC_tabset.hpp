...
class UWBP_MenuESC_tabset_C : public UWBP_PanelWidgetChildrenSelectorBase_C
{
    ...
    FWBP_MenuESC_tabset_COnSelectedModelTab OnSelectedModelTab;                       // 0x0490 (size: 0x10)
    void OnSelectedModelTab();
    FWBP_MenuESC_tabset_COnSelectedDistributionTab OnSelectedDistributionTab;         // 0x04A0 (size: 0x10)

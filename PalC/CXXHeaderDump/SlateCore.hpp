...
{
    TEnumAsByte<ESlateCheckBoxType> CheckBoxType;                                     // 0x0008 (size: 0x1)
...
struct FSlateBrush
{
    ...
    TEnumAsByte<ESlateBrushDrawType> DrawAs;                                          // 0x0011 (size: 0x1)
    TEnumAsByte<ESlateBrushTileType> Tiling;                                          // 0x0012 (size: 0x1)
    TEnumAsByte<ESlateBrushMirrorType> Mirroring;                                     // 0x0013 (size: 0x1)
    TEnumAsByte<ESlateBrushImageType> ImageType;                                      // 0x0014 (size: 0x1)
...
struct FSlateBrushOutlineSettings
{
    ...
    TEnumAsByte<ESlateBrushRoundingType> RoundingType;                                // 0x0038 (size: 0x1)

#ifndef UE4SS_SDK_BP_BuildObject_Glass_Roof_HPP
#define UE4SS_SDK_BP_BuildObject_Glass_Roof_HPP

class ABP_BuildObject_Glass_Roof_C : public APalBuildObjectBasicBase
{

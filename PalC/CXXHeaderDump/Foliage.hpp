...
class UFoliageEditPresetData : public UObject
{
    ...
    TArray<class UFoliageType*> FoliageTypes;
...
class UFoliageType : public UObject
{
    ...
    uint8 AlignToNormal;
    uint8 AverageNormal;
    uint8 AverageNormalSingleComponent;
    float AlignMaxAngle;
    uint8 RandomYaw;
...
class UFoliageType_Actor : public UFoliageType
{
    ...
    TSubclassOf<class UFoliageInstancedStaticMeshComponent> StaticMeshOnlyComponentClass;

...
class UFoliageEditPresetData : public UObject
{
    ...
    float PaintDensity;                                                               // 0x002C (size: 0x4)
    float EraseDensity;                                                               // 0x0030 (size: 0x4)
    bool bFilterLandscape;                                                            // 0x0034 (size: 0x1)
    bool bFilterStaticMeshes;                                                         // 0x0035 (size: 0x1)
...
class UFoliageInstancedStaticMeshComponent : public UHierarchicalInstancedStaticMeshComponent
{
    ...
    bool bEnableDiscardOnLoad;                                                        // 0x08F8 (size: 0x1)
    FGuid GenerationGuid;                                                             // 0x08FC (size: 0x10)
...
class UFoliageType : public UObject
{
    ...
    TEnumAsByte<EComponentMobility> Mobility;                                         // 0x0178 (size: 0x1)
    ...
    TEnumAsByte<EHasCustomNavigableGeometry> CustomNavigableGeometry;                 // 0x0338 (size: 0x1)

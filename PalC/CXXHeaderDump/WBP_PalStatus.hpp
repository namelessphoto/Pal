...
class UWBP_PalStatus_C : public UPalUICharacterStatus
{
    ...
    FPalDataTableRowName_UIInputAction FavoritePalAction;                             // 0x04AC (size: 0x8)
    FPalDataTableRowName_UIInputAction DropPalAction;                                 // 0x04B4 (size: 0x8)
    FPalUIActionBindData FavoritePalActionHandle;                                     // 0x04BC (size: 0x4)
    FPalUIActionBindData DropPalActionHandle;                                         // 0x04C0 (size: 0x4)
    class UPalIndividualCharacterHandle* LastHoveredPalHandle;                        // 0x04C8 (size: 0x8)
    FDataTableRowHandle DropPalDialogMsgID;                                           // 0x04D0 (size: 0x10)

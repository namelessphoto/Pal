...
class UWBP_PalWorkFarm_C : public UPalUIMapObjectStatusIndicatorBase
{
    ...
    class UCanvasPanel* Canvas_Text_Progress_Aft;                                     // 0x0420 (size: 0x8)
    class UCanvasPanel* Canvas_Text_Progress_Pre;                                     // 0x0428 (size: 0x8)
    class UCanvasPanel* Canvas_Text_Progress_Simple;                                  // 0x0430 (size: 0x8)
    ...
    class UPalMapObjectFarmBlockV2Model* Model;                                       // 0x04B0 (size: 0x8)
    TMap<class EPalFarmCropState, class FDataTableRowHandle> StateMsgIdMap;           // 0x04B8 (size: 0x50)
    TArray<class UWBP_PalCraftInfo_Pal_C*> PalInfos;                                  // 0x0508 (size: 0x10)
    FTimerHandle DisplayCheckTimer;                                                   // 0x0518 (size: 0x8)
    bool isDisplayedDetail;                                                           // 0x0520 (size: 0x1)
    bool HideNextState;                                                               // 0x0521 (size: 0x1)

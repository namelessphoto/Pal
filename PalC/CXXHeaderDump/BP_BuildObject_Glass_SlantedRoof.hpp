#ifndef UE4SS_SDK_BP_BuildObject_Glass_SlantedRoof_HPP
#define UE4SS_SDK_BP_BuildObject_Glass_SlantedRoof_HPP

class ABP_BuildObject_Glass_SlantedRoof_C : public APalBuildObjectBasicBase
{

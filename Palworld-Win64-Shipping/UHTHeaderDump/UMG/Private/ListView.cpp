...
void UListView::SetSelectionMode(TEnumAsByte<ESelectionMode> NewSelectionMode) {
}
...
void UListView::OnListItemOuterEndPlayed(AActor* ItemOuter, TEnumAsByte<EEndPlayReason> EndPlayReason) {
}

void UListView::OnListItemEndPlayed(AActor* Item, TEnumAsByte<EEndPlayReason> EndPlayReason) {
}

...
UMediaTexture::UMediaTexture() {
    ...
    this->AddressX = TextureAddress::TA_Clamp;
    this->AddressY = TextureAddress::TA_Clamp;
    this->AutoClear = false;
    this->EnableGenMips = false;
    this->NumMips = 1;
    this->NewStyleOutput = false;
    this->OutputFormat = MediaTextureOutputFormat::MTOF_Default;
    this->CurrentAspectRatio = 0.00f;
    this->CurrentOrientation = MediaTextureOrientation::MTORI_Original;

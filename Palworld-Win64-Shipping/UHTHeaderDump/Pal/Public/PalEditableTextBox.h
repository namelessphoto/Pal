...
//CROSS-MODULE INCLUDE V2: -ModuleName=UMG -ObjectName=EVirtualKeyboardType -FallbackName=EVirtualKeyboardType
//CROSS-MODULE INCLUDE V2: -ModuleName=UMG -ObjectName=ShapedTextOptions -FallbackName=ShapedTextOptions

...
APPSkyCreator::APPSkyCreator(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
    ...
    this->EditorWeatherType = EPPSkyCreatorEditorWeatherType::EditorWeather_WeatherPreset;
    ...
    this->SunPositionType = EPPSkyCreatorSunPositionType::SunPositionType_Simple;
    this->MoonPositionType = EPPSkyCreatorMoonPositionType::MoonPositionType_Simple;
    ...
    this->RenderMode = EPPVolumetricCloudRenderTargetMode::VolumetricCloudRenderTargetMode_Default;
    ...
    this->NoiseShapeResolution = EPPVolumetricCloudNoiseShapeResolution::VolumetricCloudNoiseShapeResolution_64;
    this->NoiseDetailResolution = EPPVolumetricCloudNoiseDetailResolution::VolumetricCloudNoiseDetailResolution_32;
    ...
    this->StarMapRotationType = EPPSkyCreatorStarMapRotationType::StarMapRotationType_FollowMoon;
    ...
    this->PrecipitationCollisionChannel = ECollisionChannel::ECC_WorldStatic;
    ...
    this->ExposureMethod = EAutoExposureMethod::AEM_Histogram;

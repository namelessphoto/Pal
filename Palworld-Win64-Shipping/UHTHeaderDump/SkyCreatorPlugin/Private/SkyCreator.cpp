...
ASkyCreator::ASkyCreator(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
    ...
    this->EditorWeatherType = ESkyCreatorEditorWeatherType::EditorWeather_WeatherPreset;
    ...
    this->SunPositionType = ESkyCreatorSunPositionType::SunPositionType_Simple;
    this->MoonPositionType = ESkyCreatorMoonPositionType::MoonPositionType_Simple;
    ...
    this->RenderMode = EVolumetricCloudRenderTargetMode::VolumetricCloudRenderTargetMode_Default;
    ...
    this->NoiseShapeResolution = EVolumetricCloudNoiseShapeResolution::VolumetricCloudNoiseShapeResolution_64;
    this->NoiseDetailResolution = EVolumetricCloudNoiseDetailResolution::VolumetricCloudNoiseDetailResolution_32;
    ...
    this->StarMapRotationType = ESkyCreatorStarMapRotationType::StarMapRotationType_FollowMoon;

...
UNavigationSystemV1::UNavigationSystemV1() {
    ...
    this->DefaultAgentName = TEXT("Default");
    ...
    this->bGenerateNavigationOnlyAroundNavigationInvokers = true;
...
TEnumAsByte<ENavigationQueryResult> UNavigationSystemV1::GetPathLength(UObject* WorldContextObject, const FVector& PathStart, const FVector& PathEnd, float& PathLength, ANavigationData* NavData, TSubclassOf<UNavigationQueryFilter> FilterClass) {
    return ENavigationQueryResult::Invalid;
}

TEnumAsByte<ENavigationQueryResult> UNavigationSystemV1::GetPathCost(UObject* WorldContextObject, const FVector& PathStart, const FVector& PathEnd, float& PathCost, ANavigationData* NavData, TSubclassOf<UNavigationQueryFilter> FilterClass) {
    return ENavigationQueryResult::Invalid;
}

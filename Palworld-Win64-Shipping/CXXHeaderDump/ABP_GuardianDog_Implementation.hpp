#ifndef UE4SS_SDK_ABP_GuardianDog_Implementation_HPP
#define UE4SS_SDK_ABP_GuardianDog_Implementation_HPP
...
class UABP_GuardianDog_Implementation_C : public UPalAnimInstance
{
    ...
    void ExecuteUbergraph_ABP_GuardianDog_Implementation(int32 EntryPoint);
};

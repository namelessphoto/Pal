...
{
    FAudioDeviceNotificationSubsystemDefaultCaptureDeviceChanged DefaultCaptureDeviceChanged;
    void OnAudioDefaultDeviceChanged(EAudioDeviceChangedRole AudioDeviceRole, FString DeviceID);
    FAudioDeviceNotificationSubsystemDefaultRenderDeviceChanged DefaultRenderDeviceChanged;
    void OnAudioDefaultDeviceChanged(EAudioDeviceChangedRole AudioDeviceRole, FString DeviceID);
    FAudioDeviceNotificationSubsystemDeviceAdded DeviceAdded;
    void OnAudioDeviceChange(FString DeviceID);
    FAudioDeviceNotificationSubsystemDeviceRemoved DeviceRemoved;
    void OnAudioDeviceChange(FString DeviceID);
    FAudioDeviceNotificationSubsystemDeviceStateChanged DeviceStateChanged;
    void OnAudioDeviceStateChanged(FString DeviceID, EAudioDeviceChangedState NewState);
    FAudioDeviceNotificationSubsystemDeviceSwitched DeviceSwitched;
    void OnAudioDeviceChange(FString DeviceID);

...
class ABP_EnemyCampObject_JapaneseStyle_DoorWall_02_C : public APalBuildObjectBasicBase
{
    ...
    class UStaticMeshComponent* Architecture_JapaneseStyle_DoorB_L;
    class UStaticMeshComponent* Architecture_JapaneseStyle_DoorB_R;
    ...
    class UStaticMeshComponent* Architecture_JapaneseStyle_DoorB;
    class USceneComponent* Root;
    class UBoxComponent* CheckOverlapCollision;
    float _______MoveDoor_5939C7C34381D884EFEC78991B9DA217;
    TEnumAsByte<ETimelineDirection> ________Direction_5939C7C34381D884EFEC78991B9DA217;

...
struct FAngularDriveConstraint
{
    ...
    TEnumAsByte<EAngularDriveMode> AngularDriveMode;
...
struct FAnimLinkableElement
{
    ...
    int32 SlotIndex;
    int32 SegmentIndex;
    TEnumAsByte<EAnimLinkMethod> LinkMethod;
    TEnumAsByte<EAnimLinkMethod> CachedLinkMethod;
...
struct FAnimNode_TransitionPoseEvaluator : public FAnimNode_Base
{
    ...
    TEnumAsByte<EEvaluatorDataSource> DataSource;
    TEnumAsByte<EEvaluatorMode> EvaluatorMode;
...
struct FAnimNotifyEvent : public FAnimLinkableElement
{
    ...
    TEnumAsByte<EMontageNotifyTickType> MontageTickType;
    float NotifyTriggerChance;
    TEnumAsByte<ENotifyFilterType> NotifyFilterType;
...
struct FAnimationTransitionBetweenStates : public FAnimationStateBase
{
    ...
    class UCurveFloat* CustomCurve;
    class UBlendProfile* BlendProfile;
    TEnumAsByte<ETransitionLogicType> LogicType;
...
struct FBaseAttenuationSettings
{
    ...
    TEnumAsByte<EAttenuationShape> AttenuationShape;
...
struct FBlendSpaceTriangle
{
    int32 SampleIndices;
    FVector2D Vertices;
    FBlendSpaceTriangleEdgeInfo EdgeInfo;
...
struct FBlendSpaceTriangleEdgeInfo
{
    ...
    int32 AdjacentPerimeterTriangleIndices;
    int32 AdjacentPerimeterVertexIndices;
...
struct FBodyInstance : public FBodyInstanceCore
{
    ...
    TEnumAsByte<ECollisionEnabled> CollisionEnabled;
    ESleepFamily SleepFamily;
    TEnumAsByte<EDOFMode> DOFMode;
    uint8 bUseCCD;
    uint8 bIgnoreAnalyticCollisions;
    uint8 bNotifyRigidBodyCollision;
    uint8 bSmoothEdgeCollisions;
...
struct FBoneMirrorExport
{
    ...
    TEnumAsByte<EAxis> BoneFlipAxis;
...
struct FBranchingPointMarker
{
    int32 NotifyIndex;
    float TriggerTime;
    TEnumAsByte<EAnimNotifyEventType> NotifyEventType;
...
struct FChannelDefinition
{
    ...
    uint8 bServerOpen;
    uint8 bClientOpen;
    uint8 bInitialServer;
    uint8 bInitialClient;
...
struct FCharacterMovementTickFunction : public FActorComponentTickFunction
{
};
...
struct FEdGraphPinType
{
    ...
    uint8 bSerializeAsSinglePrecisionFloat;
...
struct FFormatArgumentData
{
    ...
    TEnumAsByte<EFormatArgumentType> ArgumentValueType;
    FText ArgumentValue;
...
struct FImportanceTexture
{
    ...
    TEnumAsByte<EImportanceWeight> Weighting;
...
struct FInstancedStaticMeshInstanceDataShrink
{
...
struct FMaterialCachedExpressionEditorOnlyData
{
    ...
    FMaterialCachedParameterEditorEntry EditorEntries;
...
struct FMaterialInstanceBasePropertyOverrides
{
    ...
    uint8 bOverride_OutputTranslucentVelocity;
    uint8 TwoSided;
...
struct FMeshBuildSettings
{
    ...
    uint8 bUseBackwardsCompatibleF16TruncUVs;
...
struct FMeshProxySettings
{
    ...
    TEnumAsByte<EProxyNormalComputationMethod> NormalCalculationMethod;
    TEnumAsByte<ELandscapeCullingPrecision> LandscapeCullingPrecision;
    ...
    uint8 bAllowDistanceField;
    uint8 bReuseMeshLightmapUVs;
    uint8 bGroupIdenticalMeshesForBaking;
...
struct FMeshReductionSettings
{
    ...
    float HardAngleThreshold;
    int32 BaseLODModel;
    TEnumAsByte<EMeshFeatureImportance> SilhouetteImportance;
    TEnumAsByte<EMeshFeatureImportance> TextureImportance;
    TEnumAsByte<EMeshFeatureImportance> ShadingImportance;
    uint8 bRecalculateNormals;
    ...
    TEnumAsByte<EMeshFeatureImportance> VisibilityAggressiveness;
    TEnumAsByte<EMeshFeatureImportance> VertexColorImportance;
...
struct FNavigationLinkBase
{
    ...
    uint8 bSupportsAgent14;
    uint8 bSupportsAgent15;
    TEnumAsByte<ENavLinkDirection> Direction;
...
struct FNewLevelInstanceParams
{
    ...
    bool bPromptForSave;
    TSubclassOf<class AActor> LevelInstanceClass;
...
struct FPostProcessSettings
{
    ...
    uint8 bOverride_ColorCorrectionHighlightsMax;
    ...
    uint8 bOverride_BloomConvolutionScatterDispersion;
    ...
    uint8 bOverride_LocalExposureContrastScale;
    uint8 bOverride_LocalExposureHighlightContrastScale;
    uint8 bOverride_LocalExposureShadowContrastScale;
    uint8 bOverride_LocalExposureDetailStrength;
    uint8 bOverride_LocalExposureBlurredLuminanceBlend;
    uint8 bOverride_LocalExposureBlurredLuminanceKernelSizePercent;
    uint8 bOverride_LocalExposureMiddleGreyBias;
    ...
    uint8 bOverride_FilmGrainIntensity;
    uint8 bOverride_FilmGrainIntensityShadows;
    uint8 bOverride_FilmGrainIntensityMidtones;
    uint8 bOverride_FilmGrainIntensityHighlights;
    uint8 bOverride_FilmGrainShadowsMax;
    uint8 bOverride_FilmGrainHighlightsMin;
    uint8 bOverride_FilmGrainHighlightsMax;
    uint8 bOverride_FilmGrainTexelSize;
    uint8 bOverride_FilmGrainTexture;
    ...
    uint8 bOverride_DepthOfFieldSqueezeFactor;
    ...
    uint8 bOverride_ReflectionMethod;
    uint8 bOverride_LumenReflectionQuality;
    ...
    uint8 bOverride_DynamicGlobalIlluminationMethod;
    uint8 bOverride_LumenSceneLightingQuality;
    uint8 bOverride_LumenSceneDetail;
    uint8 bOverride_LumenSceneViewDistance;
    uint8 bOverride_LumenSceneLightingUpdateSpeed;
    uint8 bOverride_LumenFinalGatherQuality;
    uint8 bOverride_LumenFinalGatherLightingUpdateSpeed;
    uint8 bOverride_LumenMaxTraceDistance;
    uint8 bOverride_LumenDiffuseColorBoost;
    uint8 bOverride_LumenSkylightLeaking;
    uint8 bOverride_LumenFullSkylightLeakingDistance;
    uint8 bOverride_LumenRayLightingMode;
    uint8 bOverride_LumenFrontLayerTranslucencyReflections;
    uint8 bOverride_LumenSurfaceCacheResolution;
    ...
    uint8 bOverride_PathTracingEnableReferenceDOF;
    uint8 bOverride_PathTracingEnableReferenceAtmosphere;
    ...
    TEnumAsByte<EDynamicGlobalIlluminationMethod> DynamicGlobalIlluminationMethod;
    ...
    TEnumAsByte<EReflectionMethod> ReflectionMethod;
    ...
    uint8 PathTracingEnableReferenceDOF;
    uint8 PathTracingEnableReferenceAtmosphere;
...
{
    TEnumAsByte<EConstraintTransform> TranformType;
    FName ParentSpace;
    float Weight;
...
struct FSkeletalMeshOptimizationSettings
{
    ...
    uint8 bMergeCoincidentVertBones;
...
struct FSoundAttenuationSettings : public FBaseAttenuationSettings
{
    ...
    uint8 bEnableSourceDataOverride;
    uint8 bEnableSendToAudioLink;
...
struct FSoundClassProperties
{
    ...
    TEnumAsByte<EAudioOutputTarget> OutputTarget;
...
struct FSoundConcurrencySettings
{
    ...
    TEnumAsByte<EMaxConcurrentResolutionRule> ResolutionRule;
    float RetriggerTime;
    float VolumeScale;
...
struct FSpatialHashStreamingGrid
{
    ...
    int32 NumAdditionalCellToProcess;
...
{
    TArray<class UWorldPartitionRuntimeSpatialHashCell*> GridCells;
...
struct FStreamingRenderAssetPrimitiveInfo
{
    ...
    uint8 bAffectedByComponentScale;
...
struct FStructCookedMetaDataStore
{
    ...
    TMap<class FName, class FFieldCookedMetaDataStore> PropertiesMetaData;
...
class AActor : public UObject
{
    ...
    uint8 bCallPreReplication;
    uint8 bCallPreReplicationForReplay;
    uint8 bHidden;
    uint8 bTearOff;
    ...
    uint8 bAsyncPhysicsTickEnabled;
    ...
    void ActorOnInputTouchBeginSignature(TEnumAsByte<ETouchIndex> FingerIndex, class AActor* TouchedActor);
    FActorOnInputTouchEnd OnInputTouchEnd;
    void ActorOnInputTouchEndSignature(TEnumAsByte<ETouchIndex> FingerIndex, class AActor* TouchedActor);
    FActorOnInputTouchEnter OnInputTouchEnter;
    void ActorBeginTouchOverSignature(TEnumAsByte<ETouchIndex> FingerIndex, class AActor* TouchedActor);
    FActorOnInputTouchLeave OnInputTouchLeave;
    void ActorEndTouchOverSignature(TEnumAsByte<ETouchIndex> FingerIndex, class AActor* TouchedActor);
    ...
    void ActorEndPlaySignature(class AActor* Actor, TEnumAsByte<EEndPlayReason> EndPlayReason);
    ...
    void ReceiveActorOnInputTouchLeave(const TEnumAsByte<ETouchIndex> FingerIndex);
    void ReceiveActorOnInputTouchEnter(const TEnumAsByte<ETouchIndex> FingerIndex);
    void ReceiveActorOnInputTouchEnd(const TEnumAsByte<ETouchIndex> FingerIndex);
    void ReceiveActorOnInputTouchBegin(const TEnumAsByte<ETouchIndex> FingerIndex);
    ...
    void K2_AttachRootComponentToActor(class AActor* InParentActor, FName InSocketName, TEnumAsByte<EAttachLocation> AttachLocationType, bool bWeldSimulatedBodies);
    void K2_AttachRootComponentTo(class USceneComponent* InParent, FName InSocketName, TEnumAsByte<EAttachLocation> AttachLocationType, bool bWeldSimulatedBodies);
...
class ACharacter : public APawn
{
    ...
    FCharacterLandedDelegate LandedDelegate;
...
class AController : public AActor
{
    ...
    FControllerOnPossessedPawnChanged OnPossessedPawnChanged;
...
class ALODActor : public AActor
{
    ...
    void OnSubActorEndPlay(class AActor* Actor, TEnumAsByte<EEndPlayReason> Reason);
};
...
{
    TSubclassOf<class AActor> RepresentedClass;
    TSubclassOf<class AActor> AcceptedClass;
...
class APawn : public AActor
{
    ...
    class AController* PreviousController;
    FPawnReceiveControllerChangedDelegate ReceiveControllerChangedDelegate;
    void PawnControllerChangedSignature(class APawn* Pawn, class AController* OldController, class AController* NewController);
    FPawnReceiveRestartedDelegate ReceiveRestartedDelegate;
    void PawnRestartedSignature(class APawn* Pawn);
    FVector ControlInputVector;
    FVector LastControlInputVector;
    TSubclassOf<class UInputComponent> OverrideInputComponentClass;
...
class APlayerController : public AController
{
    ...
    TSubclassOf<class UAsyncPhysicsData> AsyncPhysicsDataClass;
    class UAsyncPhysicsInputComponent* AsyncPhysicsDataComponent;
    ...
    uint8 bEnableMotionControls;
    uint8 bEnableStreamingSource;
    uint8 bStreamingSourceShouldActivate;
    uint8 bStreamingSourceShouldBlockOnSlowStreaming;
    ...
    TSubclassOf<class UPlayerInput> OverridePlayerInputClass;
    ...
    void PlayDynamicForceFeedback(float Intensity, float Duration, bool bAffectsLeftLarge, bool bAffectsLeftSmall, bool bAffectsRightLarge, bool bAffectsRightSmall, TEnumAsByte<EDynamicForceFeedbackAction> action, FLatentActionInfo LatentInfo);
    void Pause();
    ...
    class AHUD* GetHUD();
    bool GetHitResultUnderFingerForObjects(TEnumAsByte<ETouchIndex> FingerIndex, const TArray<TEnumAsByte<EObjectTypeQuery>>& ObjectTypes, bool bTraceComplex, FHitResult& HitResult);
...
class APlayerState : public AInfo
{
    ...
    FPlayerStateOnPawnSet OnPawnSet;
...
class AWorldDataLayers : public AInfo
{
    ...
    TMap<class FName, class TWeakObjectPtr<UDataLayerInstance>> DeprecatedDataLayerNameToDataLayerInstance;
...
class AWorldSettings : public AInfo
{
    ...
    uint8 bGenerateSingleClusterForLevel;
    ...
    TArray<class UDataLayerAsset*> BaseNavmeshDataLayers;
    float WorldToMeters;
    float KillZ;
...
{
    TMap<class FName, class AActor*> Actors;
...
class UAnimBlueprintGeneratedClass : public UBlueprintGeneratedClass
{
    ...
    TMap<class UScriptStruct*, class FAnimNodeStructData> NodeTypeMap;
...
class UAnimDataModel : public UObject
{
    ...
    FAnimDataModelModifiedEventDynamic ModifiedEventDynamic;
    void AnimDataModelModifiedDynamicEvent(EAnimDataModelNotifyType NotifType, class UAnimDataModel* Model, const FAnimDataModelNotifPayload& Payload);
...
class UAnimInstance : public UObject
{
    ...
    uint8 bReceiveNotifiesFromLinkedInstances;
    uint8 bPropagateNotifiesToLinkedInstances;
    uint8 bUseMainInstanceMontageEvaluationData;
...
class UAnimMontage : public UAnimCompositeBase
{
    ...
    class UBlendProfile* BlendProfileIn;
    class UBlendProfile* BlendProfileOut;
...
class UAnimSequence : public UAnimSequenceBase
{
    ...
    TMap<class FAnimationAttributeIdentifier, class FAttributeCurve> AttributeCurves;
...
{
    TSubclassOf<class UAsyncPhysicsData> DataClass;
    TArray<class UAsyncPhysicsData*> BufferedData;
    class UAsyncPhysicsData* DataToConsume;
    class UAsyncPhysicsData* DataToWrite;
...
class UAudioComponent : public USceneComponent
{
    ...
    uint8 bCanPlayMultipleInstances;
    uint8 bDisableParameterUpdatesWhilePlaying;
...
class UBlueprintGeneratedClass : public UClass
{
    ...
    TMap<class FName, class FGuid> CookedPropertyGuids;
...
class UBlueprintPlatformLibrary : public UBlueprintFunctionLibrary
{
    ...
    void SetAllowedDeviceOrientation(TEnumAsByte<EScreenOrientation> NewAllowedDeviceOrientation);
    ...
    TEnumAsByte<EScreenOrientation> GetAllowedDeviceOrientation();
...
class UBodySetup : public UBodySetupCore
{
    ...
    uint8 bNeverNeedsCookedCollisionData;
    class UPhysicalMaterial* PhysMaterial;
    FWalkableSlopeOverride WalkableSlopeOverride;
...
class UCharacterMovementComponent : public UPawnMovementComponent
{
    ...
    FCharacterMovementTickFunction AsyncTick_PreProcess;
    FCharacterMovementTickFunction AsyncTick_MainProcess;
    FCharacterMovementTickFunction AsyncTick_PostProcess;
...
class UCheatManager : public UObject
{
    ...
    void ReceiveEndPlay();
    void PlayersOnly();
    void OnPlayerEndPlayed(class AActor* Player, TEnumAsByte<EEndPlayReason> EndPlayReason);
...
class UChildActorComponent : public USceneComponent
{
    ...
    void ReturnSelfDelegate__DelegateSignature(class UChildActorComponent* Self);
...
class UClassCookedMetaData : public UObject
{
    ...
    TMap<class FName, class FStructCookedMetaDataStore> FunctionsMetaData;
...
class UConstraintInstanceBlueprintLibrary : public UBlueprintFunctionLibrary
{
    ...
    void SetAngularDriveMode(FConstraintInstanceAccessor& Accessor, TEnumAsByte<EAngularDriveMode> DriveMode);
    ...
    void GetAngularDriveMode(FConstraintInstanceAccessor& Accessor, TEnumAsByte<EAngularDriveMode>& OutDriveMode);
...
class UDEPRECATED_DataLayer : public UObject
{
    ...
    FColor DebugColor;
    class UDEPRECATED_DataLayer* Parent;
    TArray<class UDEPRECATED_DataLayer*> Children;
...
{
    EDataLayerRuntimeState InitialRuntimeState;
    class UDataLayerInstance* Parent;
    TArray<class UDataLayerInstance*> Children;
...
{
    FDataLayerSubsystemOnDataLayerRuntimeStateChanged OnDataLayerRuntimeStateChanged;
...
class UDataTableFunctionLibrary : public UBlueprintFunctionLibrary
{
    ...
    void EvaluateCurveTableRow(class UCurveTable* CurveTable, FName RowName, float InXY, TEnumAsByte<EEvaluateCurveTableResult>& OutResult, float& OutXY, FString ContextString);
...
class UDeviceProfile : public UTextureLODSettings
{
    ...
    uint8 bIsVisibleForAssets;
    class UDeviceProfile* Parent;
...
{
    TArray<class UDeviceProfile*> Profiles;
    TArray<class UDeviceProfile*> BackupProfiles;
...
class UEngine : public UObject
{
    ...
    class UTexture2D* DefaultFilmGrainTexture;
    ...
    class UPhysicalMaterial* DefaultDestructiblePhysMaterial;
    ...
    class UTexture2D* BlueNoiseScalarTexture;
    class UTexture2D* BlueNoiseVec2Texture;
...
class UGameInstance : public UObject
{
    ...
    FGameInstanceOnInputDeviceConnectionChange OnInputDeviceConnectionChange;
    ...
    FGameInstanceOnUserInputDevicePairingChange OnUserInputDevicePairingChange;
...
class UGameplayStatics : public UBlueprintFunctionLibrary
{
    ...
    class UAudioComponent* SpawnDialogueAttached(class UDialogueWave* Dialogue, const FDialogueContext& Context, class USceneComponent* AttachToComponent, FName AttachPointName, FVector Location, FRotator Rotation, TEnumAsByte<EAttachLocation> LocationType, bool bStopWhenAttachedToDestroyed, float VolumeMultiplier, float PitchMultiplier, float StartTime, class USoundAttenuation* AttenuationSettings, bool bAutoDestroy);
    ...
    class UDecalComponent* SpawnDecalAttached(class UMaterialInterface* DecalMaterial, FVector DecalSize, class USceneComponent* AttachToComponent, FName AttachPointName, FVector Location, FRotator Rotation, TEnumAsByte<EAttachLocation> LocationType, float LifeSpan);
    ...
    bool BlueprintSuggestProjectileVelocity(const class UObject* WorldContextObject, FVector& TossVelocity, FVector StartLocation, FVector EndLocation, float LaunchSpeed, float OverrideGravityZ, TEnumAsByte<ESuggestProjVelocityTraceOption> TraceOption, float CollisionRadius, bool bFavorHighArc, bool bDrawDebug);
    bool Blueprint_PredictProjectilePath_ByTraceChannel(const class UObject* WorldContextObject, FHitResult& OutHit, TArray<FVector>& OutPathPositions, FVector& OutLastTraceDestination, FVector StartPos, FVector LaunchVelocity, bool bTracePath, float ProjectileRadius, TEnumAsByte<ECollisionChannel> TraceChannel, bool bTraceComplex, const TArray<class AActor*>& ActorsToIgnore, TEnumAsByte<EDrawDebugTrace> DrawDebugType, float DrawDebugTime, float SimFrequency, float MaxSimTime, float OverrideGravityZ);
    bool Blueprint_PredictProjectilePath_ByObjectType(const class UObject* WorldContextObject, FHitResult& OutHit, TArray<FVector>& OutPathPositions, FVector& OutLastTraceDestination, FVector StartPos, FVector LaunchVelocity, bool bTracePath, float ProjectileRadius, const TArray<TEnumAsByte<EObjectTypeQuery>>& ObjectTypes, bool bTraceComplex, const TArray<class AActor*>& ActorsToIgnore, TEnumAsByte<EDrawDebugTrace> DrawDebugType, float DrawDebugTime, float SimFrequency, float MaxSimTime, float OverrideGravityZ);
...
class UGarbageCollectionSettings : public UDeveloperSettings
{
    ...
    uint8 VerifyGCObjectNames;
    uint8 VerifyUObjectsAreNotFGCObjects;
    uint8 PendingKillEnabled;
...
class UHLODLayer : public UObject
{
    ...
    TSubclassOf<class UHLODBuilder> HLODBuilderClass;
    class UHLODBuilderSettings* HLODBuilderSettings;
    uint8 bIsSpatiallyLoaded;
    int32 CellSize;
    double LoadingRange;
...
{
    TMap<class AWorldPartitionHLOD*, class UWorldPartitionRuntimeCell*> LoadedHLODCellMap;
...
{
    uint8 bUseTranslatedInstanceSpace;
...
class UImportanceSamplingLibrary : public UBlueprintFunctionLibrary
{
    ...
    FImportanceTexture MakeImportanceTexture(class UTexture2D* Texture, TEnumAsByte<EImportanceWeight> WeightingFunc);
    ...
    void BreakImportanceTexture(const FImportanceTexture& ImportanceTexture, class UTexture2D*& Texture, TEnumAsByte<EImportanceWeight>& WeightingFunc);
};
...
class UInputComponent : public UActorComponent
{
    ...
    void OnInputOwnerEndPlayed(class AActor* InOwner, TEnumAsByte<EEndPlayReason> EndPlayReason);
...
class UInputSettings : public UObject
{
    ...
    uint8 bEnableLegacyInputScales;
    uint8 bEnableMotionControls;
    uint8 bFilterInputByPlatformUser;
    uint8 bShouldFlushPressedKeysOnViewportFocusLost;
    uint8 bEnableDynamicComponentInputBinding;
    uint8 bAlwaysShowTouchInterface;
    uint8 bShowConsoleOnFourFingerTap;
    uint8 bEnableGestureRecognizer;
    uint8 bUseAutocorrect;
...
{
    TArray<FInstancedStaticMeshInstanceData> PerInstanceSMData;
    TArray<FInstancedStaticMeshInstanceDataShrink> PerInstanceSMDataShrink;
...
class UKismetMathLibrary : public UBlueprintFunctionLibrary
{
    ...
    FVector VEase(FVector A, FVector B, float Alpha, TEnumAsByte<EEasingFunc> EasingFunc, float BlendExp, int32 Steps);
    FDateTime UtcNow();
    ...
    FDateTime Today();
    FTransform TLerp(const FTransform& A, const FTransform& B, float Alpha, TEnumAsByte<ELerpInterpolationMode> InterpMode);
    ...
    FTransform TEase(const FTransform& A, const FTransform& B, float Alpha, TEnumAsByte<EEasingFunc> EasingFunc, float BlendExp, int32 Steps);
    double Tan(double A);
    ...
    FRotator REase(FRotator A, FRotator B, float Alpha, bool bShortestPath, TEnumAsByte<EEasingFunc> EasingFunc, float BlendExp, int32 Steps);
    ...
    FVector RandomPointInBoundingBoxFromStream_Box(const FBox Box, const FRandomStream& Stream);
    FVector RandomPointInBoundingBoxFromStream(const FVector Center, const FVector HalfSize, const FRandomStream& Stream);
    ...
    void Matrix_SetColumn(FMatrix& M, TEnumAsByte<EMatrixColumns> Column, FVector Value);
    void Matrix_SetAxis(FMatrix& M, TEnumAsByte<EAxis> Axis, FVector AxisVector);
    ...
    FMatrix Matrix_Mirror(const FMatrix& M, TEnumAsByte<EAxis> MirrorAxis, TEnumAsByte<EAxis> FlipAxis);
    ...
    FVector Matrix_GetUnitAxis(const FMatrix& M, TEnumAsByte<EAxis> Axis);
    ...
    FVector Matrix_GetScaledAxis(const FMatrix& M, TEnumAsByte<EAxis> Axis);
    ...
    FVector Matrix_GetColumn(const FMatrix& M, TEnumAsByte<EMatrixColumns> Column);
    ...
    double Ease(double A, double B, double Alpha, TEnumAsByte<EEasingFunc> EasingFunc, double BlendExp, int32 Steps);
    ...
    void BreakVector3f(FVector3f InVec, float& X, float& Y, float& Z);
...
class UKismetNodeHelperLibrary : public UBlueprintFunctionLibrary
{
    ...
    int32 GetValidIntValue(const class UEnum* Enum, int32 EnumeratorValue);
    int64 GetValidInt64Value(const class UEnum* Enum, int64 EnumeratorValue);
    ...
    FString GetIntEnumeratorUserFriendlyName(const class UEnum* Enum, int32 EnumeratorValue);
    FString GetInt64EnumeratorUserFriendlyName(const class UEnum* Enum, int64 EnumeratorValue);
    ...
    int32 GetEnumeratorIntValueFromIndex(const class UEnum* Enum, int32 EnumeratorIndex);
    int64 GetEnumeratorInt64ValueFromIndex(const class UEnum* Enum, int64 EnumeratorIndex);
...
class UKismetStringLibrary : public UBlueprintFunctionLibrary
{
    ...
    bool StartsWith(FString SourceString, FString InPrefix, TEnumAsByte<ESearchCase> SearchCase);
    bool Split(FString SourceString, FString InStr, FString& LeftS, FString& RightS, TEnumAsByte<ESearchCase> SearchCase, TEnumAsByte<ESearchDir> SearchDir);
    ...
    int32 ReplaceInline(FString& SourceString, FString SearchText, FString ReplacementText, TEnumAsByte<ESearchCase> SearchCase);
    FString Replace(FString SourceString, FString From, FString To, TEnumAsByte<ESearchCase> SearchCase);
    ...
    bool MatchesWildcard(FString SourceString, FString Wildcard, TEnumAsByte<ESearchCase> SearchCase);
    int32 Len(FString S);
    ...
    bool EndsWith(FString SourceString, FString InSuffix, TEnumAsByte<ESearchCase> SearchCase);
...
class UKismetSystemLibrary : public UBlueprintFunctionLibrary
{
    ...
    void StackTrace();
    bool SphereTraceSingleForObjects(const class UObject* WorldContextObject, const FVector Start, const FVector End, float Radius, const TArray<TEnumAsByte<EObjectTypeQuery>>& ObjectTypes, bool bTraceComplex, const TArray<class AActor*>& ActorsToIgnore, TEnumAsByte<EDrawDebugTrace> DrawDebugType, FHitResult& OutHit, bool bIgnoreSelf, FLinearColor TraceColor, FLinearColor TraceHitColor, float DrawTime);
    bool SphereTraceSingleByProfile(const class UObject* WorldContextObject, const FVector Start, const FVector End, float Radius, FName ProfileName, bool bTraceComplex, const TArray<class AActor*>& ActorsToIgnore, TEnumAsByte<EDrawDebugTrace> DrawDebugType, FHitResult& OutHit, bool bIgnoreSelf, FLinearColor TraceColor, FLinearColor TraceHitColor, float DrawTime);
    bool SphereTraceSingle(const class UObject* WorldContextObject, const FVector Start, const FVector End, float Radius, TEnumAsByte<ETraceTypeQuery> TraceChannel, bool bTraceComplex, const TArray<class AActor*>& ActorsToIgnore, TEnumAsByte<EDrawDebugTrace> DrawDebugType, FHitResult& OutHit, bool bIgnoreSelf, FLinearColor TraceColor, FLinearColor TraceHitColor, float DrawTime);
    bool SphereTraceMultiForObjects(const class UObject* WorldContextObject, const FVector Start, const FVector End, float Radius, const TArray<TEnumAsByte<EObjectTypeQuery>>& ObjectTypes, bool bTraceComplex, const TArray<class AActor*>& ActorsToIgnore, TEnumAsByte<EDrawDebugTrace> DrawDebugType, TArray<FHitResult>& OutHits, bool bIgnoreSelf, FLinearColor TraceColor, FLinearColor TraceHitColor, float DrawTime);
    bool SphereTraceMultiByProfile(const class UObject* WorldContextObject, const FVector Start, const FVector End, float Radius, FName ProfileName, bool bTraceComplex, const TArray<class AActor*>& ActorsToIgnore, TEnumAsByte<EDrawDebugTrace> DrawDebugType, TArray<FHitResult>& OutHits, bool bIgnoreSelf, FLinearColor TraceColor, FLinearColor TraceHitColor, float DrawTime);
    bool SphereTraceMulti(const class UObject* WorldContextObject, const FVector Start, const FVector End, float Radius, TEnumAsByte<ETraceTypeQuery> TraceChannel, bool bTraceComplex, const TArray<class AActor*>& ActorsToIgnore, TEnumAsByte<EDrawDebugTrace> DrawDebugType, TArray<FHitResult>& OutHits, bool bIgnoreSelf, FLinearColor TraceColor, FLinearColor TraceHitColor, float DrawTime);
    ...
    void QuitGame(const class UObject* WorldContextObject, class APlayerController* SpecificPlayer, TEnumAsByte<EQuitPreference> QuitPreference, bool bIgnorePlatformRestrictions);
    ...
    void MoveComponentTo(class USceneComponent* Component, FVector TargetRelativeLocation, FRotator TargetRelativeRotation, bool bEaseOut, bool bEaseIn, float OverTime, bool bForceShortestRotationPath, TEnumAsByte<EMoveComponentAction> MoveAction, FLatentActionInfo LatentInfo);
    ...
    bool LineTraceSingleForObjects(const class UObject* WorldContextObject, const FVector Start, const FVector End, const TArray<TEnumAsByte<EObjectTypeQuery>>& ObjectTypes, bool bTraceComplex, const TArray<class AActor*>& ActorsToIgnore, TEnumAsByte<EDrawDebugTrace> DrawDebugType, FHitResult& OutHit, bool bIgnoreSelf, FLinearColor TraceColor, FLinearColor TraceHitColor, float DrawTime);
    bool LineTraceSingleByProfile(const class UObject* WorldContextObject, const FVector Start, const FVector End, FName ProfileName, bool bTraceComplex, const TArray<class AActor*>& ActorsToIgnore, TEnumAsByte<EDrawDebugTrace> DrawDebugType, FHitResult& OutHit, bool bIgnoreSelf, FLinearColor TraceColor, FLinearColor TraceHitColor, float DrawTime);
    ...
    bool LineTraceMultiForObjects(const class UObject* WorldContextObject, const FVector Start, const FVector End, const TArray<TEnumAsByte<EObjectTypeQuery>>& ObjectTypes, bool bTraceComplex, const TArray<class AActor*>& ActorsToIgnore, TEnumAsByte<EDrawDebugTrace> DrawDebugType, TArray<FHitResult>& OutHits, bool bIgnoreSelf, FLinearColor TraceColor, FLinearColor TraceHitColor, float DrawTime);
    bool LineTraceMultiByProfile(const class UObject* WorldContextObject, const FVector Start, const FVector End, FName ProfileName, bool bTraceComplex, const TArray<class AActor*>& ActorsToIgnore, TEnumAsByte<EDrawDebugTrace> DrawDebugType, TArray<FHitResult>& OutHits, bool bIgnoreSelf, FLinearColor TraceColor, FLinearColor TraceHitColor, float DrawTime);
    ...
    void CollectGarbage();
    bool CapsuleTraceSingleForObjects(const class UObject* WorldContextObject, const FVector Start, const FVector End, float Radius, float HalfHeight, const TArray<TEnumAsByte<EObjectTypeQuery>>& ObjectTypes, bool bTraceComplex, const TArray<class AActor*>& ActorsToIgnore, TEnumAsByte<EDrawDebugTrace> DrawDebugType, FHitResult& OutHit, bool bIgnoreSelf, FLinearColor TraceColor, FLinearColor TraceHitColor, float DrawTime);
    bool CapsuleTraceSingleByProfile(const class UObject* WorldContextObject, const FVector Start, const FVector End, float Radius, float HalfHeight, FName ProfileName, bool bTraceComplex, const TArray<class AActor*>& ActorsToIgnore, TEnumAsByte<EDrawDebugTrace> DrawDebugType, FHitResult& OutHit, bool bIgnoreSelf, FLinearColor TraceColor, FLinearColor TraceHitColor, float DrawTime);
    ...
    bool CapsuleTraceMultiForObjects(const class UObject* WorldContextObject, const FVector Start, const FVector End, float Radius, float HalfHeight, const TArray<TEnumAsByte<EObjectTypeQuery>>& ObjectTypes, bool bTraceComplex, const TArray<class AActor*>& ActorsToIgnore, TEnumAsByte<EDrawDebugTrace> DrawDebugType, TArray<FHitResult>& OutHits, bool bIgnoreSelf, FLinearColor TraceColor, FLinearColor TraceHitColor, float DrawTime);
    bool CapsuleTraceMultiByProfile(const class UObject* WorldContextObject, const FVector Start, const FVector End, float Radius, float HalfHeight, FName ProfileName, bool bTraceComplex, const TArray<class AActor*>& ActorsToIgnore, TEnumAsByte<EDrawDebugTrace> DrawDebugType, TArray<FHitResult>& OutHits, bool bIgnoreSelf, FLinearColor TraceColor, FLinearColor TraceHitColor, float DrawTime);
    ...
    bool BoxTraceSingleForObjects(const class UObject* WorldContextObject, const FVector Start, const FVector End, const FVector HalfSize, const FRotator Orientation, const TArray<TEnumAsByte<EObjectTypeQuery>>& ObjectTypes, bool bTraceComplex, const TArray<class AActor*>& ActorsToIgnore, TEnumAsByte<EDrawDebugTrace> DrawDebugType, FHitResult& OutHit, bool bIgnoreSelf, FLinearColor TraceColor, FLinearColor TraceHitColor, float DrawTime);
    bool BoxTraceSingleByProfile(const class UObject* WorldContextObject, const FVector Start, const FVector End, const FVector HalfSize, const FRotator Orientation, FName ProfileName, bool bTraceComplex, const TArray<class AActor*>& ActorsToIgnore, TEnumAsByte<EDrawDebugTrace> DrawDebugType, FHitResult& OutHit, bool bIgnoreSelf, FLinearColor TraceColor, FLinearColor TraceHitColor, float DrawTime);
    ...
    bool BoxTraceMultiForObjects(const class UObject* WorldContextObject, const FVector Start, const FVector End, const FVector HalfSize, const FRotator Orientation, const TArray<TEnumAsByte<EObjectTypeQuery>>& ObjectTypes, bool bTraceComplex, const TArray<class AActor*>& ActorsToIgnore, TEnumAsByte<EDrawDebugTrace> DrawDebugType, TArray<FHitResult>& OutHits, bool bIgnoreSelf, FLinearColor TraceColor, FLinearColor TraceHitColor, float DrawTime);
    bool BoxTraceMultiByProfile(const class UObject* WorldContextObject, const FVector Start, const FVector End, FVector HalfSize, const FRotator Orientation, FName ProfileName, bool bTraceComplex, const TArray<class AActor*>& ActorsToIgnore, TEnumAsByte<EDrawDebugTrace> DrawDebugType, TArray<FHitResult>& OutHits, bool bIgnoreSelf, FLinearColor TraceColor, FLinearColor TraceHitColor, float DrawTime);
...
class ULevel : public UObject
{
    ...
    uint8 bIsVisible;
    uint8 bIsPartitioned;
    class AWorldSettings* WorldSettings;
    class AWorldDataLayers* WorldDataLayers;
...
class ULightComponentBase : public USceneComponent
{
    ...
    TEnumAsByte<ECastRayTracedShadow> CastRaytracedShadow;
    ...
    void SetCastShadows(bool bNewValue);
    void SetCastRaytracedShadows(TEnumAsByte<ECastRayTracedShadow> bNewValue);
...
class UMaterial : public UMaterialInterface
{
    ...
    TArray<class UPhysicalMaterial*> RenderTracePhysicalMaterialOutputs;
    ...
    uint8 bMobileEnableHighQualityBRDF;
    ...
    uint8 bEnableExecWire;
    uint8 bEnableNewHLSLGenerator;
...
class UMaterialEditorOnlyData : public UMaterialInterfaceEditorOnlyData
{
    ...
    FVector2MaterialInput CustomizedUVs;
...
class UMaterialExpression : public UObject
{
    ...
    class UMaterialExpression* SubgraphExpression;
    FGuid MaterialExpressionGuid;
    class UMaterial* Material;
    class UMaterialFunction* Function;
    FString Desc;
    uint8 bRealtimePreview;
    uint8 bNeedToUpdatePreview;
    uint8 bIsParameterExpression;
    uint8 bCommentBubbleVisible;
    uint8 bShowOutputNameOnPin;
    uint8 bShowMaskColorsOnPin;
    uint8 bHidePreviewWindow;
    uint8 bCollapsed;
    uint8 bShaderInputData;
    uint8 bShowInputs;
    uint8 bShowOutputs;
...
class UMaterialExpressionComposite : public UMaterialExpression
{
    ...
    class UMaterialExpressionPinBase* InputExpressions;
    class UMaterialExpressionPinBase* OutputExpressions;
...
class UNetDriver : public UObject
{
    ...
    uint8 bNoTimeouts;
    uint8 bNeverApplyNetworkEmulationSettings;
...
class UParticleSystemComponent : public UFXSystemComponent
{
    ...
    void SetAutoAttachParams(class USceneComponent* Parent, FName SocketName, TEnumAsByte<EAttachLocation> LocationType);
...
class UPhysicsConstraintComponent : public USceneComponent
{
    ...
    FPhysicsConstraintComponentOnPlasticDeformation OnPlasticDeformation;
...
class UPlatformGameInstance : public UGameInstance
{
    ...
    void PlatformReceivedRemoteNotificationDelegate(FString InString, TEnumAsByte<EApplicationState> inAppState);
    FPlatformGameInstanceApplicationReceivedLocalNotificationDelegate ApplicationReceivedLocalNotificationDelegate;
    void PlatformReceivedLocalNotificationDelegate(FString InString, int32 inInt, TEnumAsByte<EApplicationState> inAppState);
    ...
    void PlatformScreenOrientationChangedDelegate(TEnumAsByte<EScreenOrientation> inScreenOrientation);
...
class UPrimitiveComponent : public USceneComponent
{
    ...
    uint8 bIsValidTextureStreamingBuiltData;
    ...
    FPrimitiveComponentOnComponentPhysicsStateChanged OnComponentPhysicsStateChanged;
    ...
    void ComponentOnInputTouchBeginSignature(TEnumAsByte<ETouchIndex> FingerIndex, class UPrimitiveComponent* TouchedComponent);
    FPrimitiveComponentOnInputTouchEnd OnInputTouchEnd;
    void ComponentOnInputTouchEndSignature(TEnumAsByte<ETouchIndex> FingerIndex, class UPrimitiveComponent* TouchedComponent);
    FPrimitiveComponentOnInputTouchEnter OnInputTouchEnter;
    void ComponentBeginTouchOverSignature(TEnumAsByte<ETouchIndex> FingerIndex, class UPrimitiveComponent* TouchedComponent);
    FPrimitiveComponentOnInputTouchLeave OnInputTouchLeave;
    void ComponentEndTouchOverSignature(TEnumAsByte<ETouchIndex> FingerIndex, class UPrimitiveComponent* TouchedComponent);
...
{
    TEnumAsByte<EMobileShadingPath> MobileShadingPath;
    uint8 bMobileSupportGPUScene;
    TEnumAsByte<EMobileAntiAliasingMethod> MobileAntiAliasing;
    TEnumAsByte<EMobileFloatPrecisionMode> MobileFloatPrecisionMode;
    uint8 bMobileAllowDitheredLODTransition;
    uint8 bMobileVirtualTextures;
    uint8 bDiscardUnusedQualityLevels;
    TEnumAsByte<EShaderCompressionFormat> ShaderCompressionFormat;
    ...
    uint8 bVirtualTextureAnisotropicFiltering;
    uint8 bEnableVirtualTextureOpacityMask;
    uint32 VirtualTextureTileSize;
    uint32 VirtualTextureTileBorderSize;
    uint32 VirtualTextureFeedbackFactor;
    TEnumAsByte<EWorkingColorSpace> WorkingColorSpaceChoice;
    FVector2D RedChromaticityCoordinate;
    FVector2D GreenChromaticityCoordinate;
    FVector2D BlueChromaticityCoordinate;
    FVector2D WhiteChromaticityCoordinate;
    uint8 bClearCoatEnableSecondNormal;
    TEnumAsByte<EDynamicGlobalIlluminationMethod> DynamicGlobalIllumination;
    TEnumAsByte<EReflectionMethod> Reflections;
    int32 ReflectionCaptureResolution;
    uint8 ReflectionEnvironmentLightmapMixBasedOnRoughness;
    uint8 bUseHardwareRayTracingForLumen;
    ELumenRayLightingMode LumenRayLightingMode;
    uint8 LumenFrontLayerTranslucencyReflections;
    TEnumAsByte<ELumenSoftwareTracingMode> LumenSoftwareTracingMode;
    TEnumAsByte<EShadowMapMethod> ShadowMapMethod;
    uint8 bEnableRayTracing;
    uint8 bEnableRayTracingShadows;
    uint8 bEnableRayTracingSkylight;
    uint8 bEnableRayTracingTextureLOD;
    uint8 bEnablePathTracing;
    ...
    TEnumAsByte<EFixedFoveationLevels> HMDFixedFoveationLevel;
    uint8 bHMDFixedFoveationDynamic;
    ...
    TEnumAsByte<ECompositingSampleCount> MSAASampleCount;
    ...
    uint8 bEnableCSMCaching;
    uint8 bDBuffer;
    TEnumAsByte<EClearSceneOptions> ClearSceneMethod;
    TEnumAsByte<EVelocityOutputPass> VelocityPass;
    TEnumAsByte<EVertexDeformationOutputsVelocity> VertexDeformationOutputsVelocity;
    ...
    uint8 bEnableHeterogeneousVolumes;
    ...
    uint8 bSupportCloudShadowOnForwardLitTranslucent;
    uint8 bSupportTranslucentPerObjectShadow;
    uint8 bSupportCloudShadowOnSingleLayerWater;
    uint8 bEnableStrata;
    uint32 StrataBytePerPixel;
    uint8 StrataOpaqueMaterialRoughRefraction;
    uint8 StrataDebugAdvancedVisualizationShaders;
    uint8 bMaterialRoughDiffuse;
    uint8 bMaterialEnergyConservation;
    uint8 bOrderedIndependentTransparencyEnable;
    uint8 bSupportSkinCacheShaders;
    uint8 bSkipCompilingGPUSkinVF;
    ...
    uint8 bMobileForwardEnableLocalLights;
    uint8 bMobileForwardEnableClusteredReflections;
    uint8 bMobileEnableNoPrecomputedLightingCSMShader;
    ...
    TEnumAsByte<EMobilePlanarReflectionMode> MobilePlanarReflectionMode;
...
class URuntimeSpatialHashExternalStreamingObject : public URuntimeHashExternalStreamingObjectBase
{
    ...
    TMap<class FName, class FName> CellToLevelStreamingPackage;
...
class USceneComponent : public UActorComponent
{
    ...
    uint8 bShouldSnapScaleWhenAttached;
    uint8 bShouldUpdatePhysicsVolume;
    uint8 bHiddenInGame;
    uint8 bBoundsChangeTriggersStreamingDataRebuild;
    uint8 bUseAttachParentBound;
    uint8 bComputeFastLocalBounds;
    uint8 bComputeBoundsOnceForGame;
    uint8 bComputedBoundsOnceForGame;
    uint8 bIsNotRenderAttachmentRoot;
    ...
    bool K2_AttachTo(class USceneComponent* InParent, FName InSocketName, TEnumAsByte<EAttachLocation> AttachType, bool bWeldSimulatedBodies);
...
class UShapeComponent : public UPrimitiveComponent
{
    ...
    uint8 bUseSystemDefaultObstacleAreaClass;
...
class USkeletalMesh : public USkinnedAsset
{
    ...
    class UMeshDeformer* DefaultMeshDeformer;
...
class USkeletalMeshComponent : public USkinnedMeshComponent
{
    ...
    uint8 bUpdateMeshWhenKinematic;
    uint8 bUpdateJointsFromAnimation;
    uint8 bAllowClothActors;
    ...
    uint8 bPropagateCurvesToFollowers;
    ...
    void ConstraintBrokenSignature(int32 ConstraintIndex);
    FSkeletalMeshComponentOnPlasticDeformation OnPlasticDeformation;
    void PlasticDeformationEventSignature(int32 ConstraintIndex);
...
class USkinnedMeshComponent : public UMeshComponent
{
    ...
    class USkinnedAsset* SkinnedAsset;
    TWeakObjectPtr<class USkinnedMeshComponent> LeaderPoseComponent;
    TArray<ESkinCacheUsage> SkinCacheUsage;
    bool bSetMeshDeformer;
    class UMeshDeformer* MeshDeformer;
    class UMeshDeformerInstanceSettings* MeshDeformerInstanceSettings;
    class UMeshDeformerInstance* MeshDeformerInstance;
    ...
    uint8 bUseBoundsFromLeaderPoseComponent;
    ...
    uint8 bRenderStatic;
    uint8 bIgnoreLeaderPoseComponentLOD;
    uint8 bCachedLocalBoundsUpToDate;
    uint8 bCachedWorldSpaceBoundsUpToDate;
    uint8 bForceMeshObjectUpdate;
    uint8 bFollowerShouldTickPose;
...
class USoundSubmix : public USoundSubmixWithParentBase
{
    ...
    uint8 bSendToAudioLink;
    class UAudioLinkSettingsAbstract* AudioLinkSettings;
...
class USplineComponent : public UPrimitiveComponent
{
    ...
    void SetUpVectorAtSplinePoint(int32 PointIndex, const FVector& InUpVector, TEnumAsByte<ESplineCoordinateSpace> CoordinateSpace, bool bUpdateSpline);
    void SetUnselectedSplineSegmentColor(const FLinearColor& SegmentColor);
    void SetTangentsAtSplinePoint(int32 PointIndex, const FVector& InArriveTangent, const FVector& InLeaveTangent, TEnumAsByte<ESplineCoordinateSpace> CoordinateSpace, bool bUpdateSpline);
    void SetTangentColor(const FLinearColor& TangentColor);
    void SetTangentAtSplinePoint(int32 PointIndex, const FVector& InTangent, TEnumAsByte<ESplineCoordinateSpace> CoordinateSpace, bool bUpdateSpline);
    void SetSplineWorldPoints(const TArray<FVector>& Points);
    void SetSplinePointType(int32 PointIndex, TEnumAsByte<ESplinePointType> Type, bool bUpdateSpline);
    void SetSplinePoints(const TArray<FVector>& Points, TEnumAsByte<ESplineCoordinateSpace> CoordinateSpace, bool bUpdateSpline);
    ...
    void SetRotationAtSplinePoint(int32 PointIndex, const FRotator& InRotation, TEnumAsByte<ESplineCoordinateSpace> CoordinateSpace, bool bUpdateSpline);
    void SetLocationAtSplinePoint(int32 PointIndex, const FVector& InLocation, TEnumAsByte<ESplineCoordinateSpace> CoordinateSpace, bool bUpdateSpline);
    ...
    FVector GetUpVectorAtSplinePoint(int32 PointIndex, TEnumAsByte<ESplineCoordinateSpace> CoordinateSpace);
    FVector GetUpVectorAtSplineInputKey(float InKey, TEnumAsByte<ESplineCoordinateSpace> CoordinateSpace);
    ...
    FTransform GetTransformAtSplinePoint(int32 PointIndex, TEnumAsByte<ESplineCoordinateSpace> CoordinateSpace, bool bUseScale);
    FTransform GetTransformAtSplineInputKey(float InKey, TEnumAsByte<ESplineCoordinateSpace> CoordinateSpace, bool bUseScale);
    ...
    FVector GetTangentAtSplinePoint(int32 PointIndex, TEnumAsByte<ESplineCoordinateSpace> CoordinateSpace);
    FVector GetTangentAtSplineInputKey(float InKey, TEnumAsByte<ESplineCoordinateSpace> CoordinateSpace);
    FVector GetTangentAtDistanceAlongSpline(float Distance, TEnumAsByte<ESplineCoordinateSpace> CoordinateSpace);
    TEnumAsByte<ESplinePointType> GetSplinePointType(int32 PointIndex);
    ...
    FRotator GetRotationAtSplinePoint(int32 PointIndex, TEnumAsByte<ESplineCoordinateSpace> CoordinateSpace);
    FRotator GetRotationAtSplineInputKey(float InKey, TEnumAsByte<ESplineCoordinateSpace> CoordinateSpace);
    ...
    float GetRollAtSplinePoint(int32 PointIndex, TEnumAsByte<ESplineCoordinateSpace> CoordinateSpace);
    ...
    FVector GetRightVectorAtSplinePoint(int32 PointIndex, TEnumAsByte<ESplineCoordinateSpace> CoordinateSpace);
    FVector GetRightVectorAtSplineInputKey(float InKey, TEnumAsByte<ESplineCoordinateSpace> CoordinateSpace);
    ...
    FVector GetLocationAtSplinePoint(int32 PointIndex, TEnumAsByte<ESplineCoordinateSpace> CoordinateSpace);
    FVector GetLocationAtSplineInputKey(float InKey, TEnumAsByte<ESplineCoordinateSpace> CoordinateSpace);
    FVector GetLocationAtDistanceAlongSpline(float Distance, TEnumAsByte<ESplineCoordinateSpace> CoordinateSpace);
    void GetLocationAndTangentAtSplinePoint(int32 PointIndex, FVector& Location, FVector& Tangent, TEnumAsByte<ESplineCoordinateSpace> CoordinateSpace);
    void GetLocalLocationAndTangentAtSplinePoint(int32 PointIndex, FVector& LocalLocation, FVector& LocalTangent);
    FVector GetLeaveTangentAtSplinePoint(int32 PointIndex, TEnumAsByte<ESplineCoordinateSpace> CoordinateSpace);
    ...
    FVector GetDirectionAtSplinePoint(int32 PointIndex, TEnumAsByte<ESplineCoordinateSpace> CoordinateSpace);
    FVector GetDirectionAtSplineInputKey(float InKey, TEnumAsByte<ESplineCoordinateSpace> CoordinateSpace);
    ...
    FVector GetArriveTangentAtSplinePoint(int32 PointIndex, TEnumAsByte<ESplineCoordinateSpace> CoordinateSpace);
    FVector FindUpVectorClosestToWorldLocation(const FVector& WorldLocation, TEnumAsByte<ESplineCoordinateSpace> CoordinateSpace);
    FTransform FindTransformClosestToWorldLocation(const FVector& WorldLocation, TEnumAsByte<ESplineCoordinateSpace> CoordinateSpace, bool bUseScale);
    FVector FindTangentClosestToWorldLocation(const FVector& WorldLocation, TEnumAsByte<ESplineCoordinateSpace> CoordinateSpace);
    FVector FindScaleClosestToWorldLocation(const FVector& WorldLocation);
    FRotator FindRotationClosestToWorldLocation(const FVector& WorldLocation, TEnumAsByte<ESplineCoordinateSpace> CoordinateSpace);
    float FindRollClosestToWorldLocation(const FVector& WorldLocation, TEnumAsByte<ESplineCoordinateSpace> CoordinateSpace);
    FVector FindRightVectorClosestToWorldLocation(const FVector& WorldLocation, TEnumAsByte<ESplineCoordinateSpace> CoordinateSpace);
    FVector FindLocationClosestToWorldLocation(const FVector& WorldLocation, TEnumAsByte<ESplineCoordinateSpace> CoordinateSpace);
    float FindInputKeyClosestToWorldLocation(const FVector& WorldLocation);
    FVector FindDirectionClosestToWorldLocation(const FVector& WorldLocation, TEnumAsByte<ESplineCoordinateSpace> CoordinateSpace);
    bool DivideSplineIntoPolylineRecursiveWithDistances(float StartDistanceAlongSpline, float EndDistanceAlongSpline, TEnumAsByte<ESplineCoordinateSpace> CoordinateSpace, const float MaxSquareDistanceFromSpline, TArray<FVector>& OutPoints, TArray<double>& OutDistancesAlongSpline);
    bool DivideSplineIntoPolylineRecursive(float StartDistanceAlongSpline, float EndDistanceAlongSpline, TEnumAsByte<ESplineCoordinateSpace> CoordinateSpace, const float MaxSquareDistanceFromSpline, TArray<FVector>& OutPoints);
    bool ConvertSplineToPolyLine(TEnumAsByte<ESplineCoordinateSpace> CoordinateSpace, const float MaxSquareDistanceFromSpline, TArray<FVector>& OutPoints);
    bool ConvertSplineSegmentToPolyLine(int32 SplinePointStartIndex, TEnumAsByte<ESplineCoordinateSpace> CoordinateSpace, const float MaxSquareDistanceFromSpline, TArray<FVector>& OutPoints);
    void ClearSplinePoints(bool bUpdateSpline);
    void AddSplineWorldPoint(const FVector& Position);
    void AddSplinePointAtIndex(const FVector& Position, int32 Index, TEnumAsByte<ESplineCoordinateSpace> CoordinateSpace, bool bUpdateSpline);
    void AddSplinePoint(const FVector& Position, TEnumAsByte<ESplineCoordinateSpace> CoordinateSpace, bool bUpdateSpline);
...
class USpringArmComponent : public USceneComponent
{
    ...
    uint8 bClampToMaxPhysicsDeltaTime;
...
class UStaticMeshComponent : public UMeshComponent
{
    ...
    uint8 bDisallowNanite;
    uint8 bEvaluateWorldPositionOffset;
    uint8 bEvaluateWorldPositionOffsetInRayTracing;
...
class UTransactionDiffingTestObject : public UObject
{
    ...
    TArray<class UObject*> ObjectsArray;
    class UObject* AdditionalObject;
...
class UUserInterfaceSettings : public UDeveloperSettings
{
    ...
    TMap<TEnumAsByte<EMouseCursor>, FHardwareCursorReference> HardwareCursors;
    TMap<TEnumAsByte<EMouseCursor>, FSoftClassPath> SoftwareCursors;
...
class UWorld : public UObject
{
    ...
    class AServerStreamingLevelsVisibility* ServerStreamingLevelsVisibility;
    ...
    class UContentBundleManager* ContentBundleManager;
...
{
    class UActorDescContainer* ActorDescContainer;
    class UWorldPartitionRuntimeHash* RuntimeHash;
    class UWorld* World;
    bool bEnableStreaming;
    EWorldPartitionServerStreamingMode ServerStreamingMode;
    EWorldPartitionServerStreamingOutMode ServerStreamingOutMode;
    class UWorldPartitionStreamingPolicy* StreamingPolicy;
...
class UWorldPartitionBlueprintLibrary : public UBlueprintFunctionLibrary
{
    ...
    void UnloadActors(const TArray<FGuid>& InActorsToLoad);
...
class UWorldPartitionLevelStreamingDynamic : public ULevelStreamingDynamic
{
    ...
    TWeakObjectPtr<class UWorldPartitionRuntimeLevelStreamingCell> StreamingCell;
    TWeakObjectPtr<class UWorldPartition> OuterWorldPartition;

};

class UWorldPartitionLevelStreamingPolicy : public UWorldPartitionStreamingPolicy
{
    TMap<class FName, class FName> SubObjectsToCellRemapping;
...
{
    class UWorldPartitionLevelStreamingDynamic* LevelStreaming;
...
class UWorldPartitionStreamingSourceComponent : public UActorComponent
{
    FName TargetGrid;
    FColor DebugColor;
    class UHLODLayer* TargetHLODLayer;

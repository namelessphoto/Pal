#ifndef UE4SS_SDK_ABP_MoonQueen_Implementation_HPP
#define UE4SS_SDK_ABP_MoonQueen_Implementation_HPP
...
class UABP_MoonQueen_Implementation_C : public UPalAnimInstance
{
    ...
    void ExecuteUbergraph_ABP_MoonQueen_Implementation(int32 EntryPoint);
};

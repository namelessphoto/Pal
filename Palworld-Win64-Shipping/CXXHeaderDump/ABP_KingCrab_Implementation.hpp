#ifndef UE4SS_SDK_ABP_KingCrab_Implementation_HPP
#define UE4SS_SDK_ABP_KingCrab_Implementation_HPP
...
class UABP_KingCrab_Implementation_C : public UPalAnimInstance
{
    ...
    void ExecuteUbergraph_ABP_KingCrab_Implementation(int32 EntryPoint);
};

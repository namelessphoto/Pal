...
struct FRecastNavMeshTileGenerationDebug
{
    ...
    uint8 bHeightfieldSolidFromRasterization;
    uint8 bHeightfieldSolidPostInclusionBoundsFiltering;
    uint8 bHeightfieldSolidPostHeightFiltering;
    uint8 bCompactHeightfield;
    uint8 bCompactHeightfieldEroded;
    uint8 bCompactHeightfieldRegions;
    uint8 bCompactHeightfieldDistances;
    uint8 bTileCacheLayerAreas;
    uint8 bTileCacheLayerRegions;
    uint8 bTileCacheContours;
    uint8 bTileCachePolyMesh;
    uint8 bTileCacheDetailMesh;
...
class ARecastNavMesh : public ANavigationData
{
    ...
    uint8 bUseVirtualGeometryFilteringAndDirtying;
